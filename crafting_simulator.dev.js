...
*/
var crsim_vendor={
  "mbms":{"name":"Movement speed","desc":"Magic Boots with 10% increased Movement Speed",
  ...
  "mbms+":{"name":"+ movement speed","desc":"Magic Boots with #+5% increased Movement Speed",
  ...
  "mwpd":{"name":"Flat phys. dmg","desc":"Magic Weapon with lowest tier of Adds # to # Physical Damage",
  ...
  "mwpd+":{"name":"+ flat phys. dmg","desc":"Magic Weapon with Adds # to # Physical Damage one tier higher",
  ...
  "mwpc":{"name":"Flat cold dmg","desc":"Magic Weapon with lowest tier of Adds # to # Cold Damage",
    "ing":["<rrn>Normal</rrn> Weapon","Sapphire Flask","Orb of Augmentation"],
    "bases":null,"bgroups":"|6|7|","mods":null,"rarity":{"normal":true},
    "result":{"rarity":"magic","mods":[{"id":1970,"tier":-1}]}},
  "mwpc+":{"name":"+ flat cold dmg","desc":"Magic Weapon with Adds # to # Cold Damage one tier higher",
  ...
  "mwpf":{"name":"Flat fire dmg","desc":"Magic Weapon with lowest tier of Adds # to # Fire Damage",
    "ing":["<rrn>Normal</rrn> Weapon","Ruby Flask","Orb of Augmentation"],
    "bases":null,"bgroups":"|6|7|","mods":null,"rarity":{"normal":true},
    "result":{"rarity":"magic","mods":[{"id":1972,"tier":-1}]}},
  "mwpf+":{"name":"+ flat fire dmg","desc":"Magic Weapon with Adds # to # Fire Damage one tier higher",
  ...
  "mwpl":{"name":"Flat light. dmg","desc":"Magic Weapon with lowest tier of Adds # to # Lightning Damage",
    "ing":["<rrn>Normal</rrn> Weapon","Topaz Flask","Orb of Augmentation"],
    "bases":null,"bgroups":"|6|7|","mods":null,"rarity":{"normal":true},
    "result":{"rarity":"magic","mods":[{"id":1974,"tier":-1}]}},
  "mwpl+":{"name":"+ flat light. dmg","desc":"Magic Weapon with Adds # to # Lightning Damage one tier higher",
  ...
  "mwcs":{"name":"Flat cold dmg to spells","desc":"Magic Weapon with Adds # to # Cold Damage to Spells",
  ...
  "mwfs":{"name":"Flat fire dmg to spells","desc":"Magic Weapon with Adds # to # Fire Damage to Spells",
    "ing":["<rrm>Magic</rrm> Sceptre, Wand, Rune Dagger","Ruby Ring","Orb of Alteration"],
    "bases":"|17|18|67|19|","bgroups":null,"mods":null,"rarity":{"magic":true},
    "subset":{"label":"Ring","choices":["Normal","Magic","Rare"]},
    "result":{"rarity":"magic","mods":[{"id":2287,"tier":[8,7,6]}]}},
  "mwls":{"name":"Flat light. dmg to spells","desc":"Magic Weapon with Adds # to # Lightning Damage to Spells",
    "ing":["<rrm>Magic</rrm> Sceptre, Wand, Rune Dagger","Topaz Ring","Orb of Alteration"],
    "bases":"|17|18|67|19|","bgroups":null,"mods":null,"rarity":{"magic":true},
    "subset":{"label":"Ring","choices":["Normal","Magic","Rare"]},
    "result":{"rarity":"magic","mods":[{"id":2291,"tier":[8,7,6]}]}},
  "mwls":{"name":"% phys. dmg.","desc":"Magic Weapon with #% Increased Physical Damage",
  ...
  "mwsd":{"name":"% spell dmg.","desc":"Magic Weapon with #% Increased Spell Damage",
    "ing":["Rune Dagger, Scepter, Wand","<rrm>Magic</rrm> or <rrr>Rare</rrr> Chain Belt","Blacksmith's Whetstone"],
    "bases":"|19|17|18|67|","bgroups":null,"mods":null,"rarity":{"magic":true,"normal":true,"rare":true},
    "subset":{"label":"Belt","choices":["Magic","Rare"]},
    "result":{"rarity":"magic","mods":[{"id":2312,"tier":[8,7]}]}},
  "mwsds":{"name":"% spell dmg.","desc":"Magic Weapon with #% Increased Spell Damage",
  ...
  "mwskp":{"name":"+1 Phys. Spell Gems","desc":"Magic Weapon with +1 to Level of all Physical Spell Skill Gems",
  ...
  "mwskpc":{"name":"+1 Cold Spell Gems","desc":"Magic Weapon with +1 to Level of all Cold Spell Skill Gems",
  ...
  "mwskf":{"name":"+1 Fire Spell Gems","desc":"Magic Weapon with +1 to Level of all Fire Spell Skill Gems",
  ...
  "mwskl":{"name":"+1 Light. Spell Gems","desc":"Magic Weapon with +1 to Level of all Lightning Spell Skill Gems",
  ...
  "mwskc":{"name":"+1 Chaos. Spell Gems","desc":"Magic Weapon with +1 to Level of all Chaos Spell Skill Gems",
  ...
  "mhmg":{"name":"+1 Minion Gems","desc":"Helmet with +1 to Level of Socketed Minion Gems",
  ...
  "mjcr":{"name":"Chaos resistance","desc":"Magic Ring or Amulet with #% to Chaos Resistance",
  ...
  "mjcr+":{"name":"+ chaos resistance","desc":"Magic Ring or Amulet with #+5% to Chaos Resistance",
...
var crsim_resswaps=[
  ...
  {"text":"+#% to [RES] Resistance, #% of [RES] Damage Leeched as Life","bgrp":true,"special":false,"addmgrps":""},
  {"text":"+#% to maximum [RES] Resistance","bgrp":false,"special":false,"addmgrps":"12|"},
  {"text":"+#% to [RES] Resistance, #% of Physical Damage from Hits taken as [RES] Damage","bgrp":true,"special":false,"addmgrps":""},
  {"text":"Added Small Passive Skills also grant: +#% to [RES] Resistance","bgrp":false,"special":false,"addmgrps":""},
  {"text":"+#% to Fire Resistance, # to # added Fire Damage against Burning Enemies","bgrp":true,"special":true,"addmgrps":""},
  {"text":"+#% to Cold Resistance, #% increased Damage with Hits against Chilled Enemies","bgrp":true,"special":true,"addmgrps":""},
  {"text":"+#% to Lightning Resistance, #% increased Critical Strike Chance against Shocked Enemies","bgrp":true,"special":true,"addmgrps":""}
];
...
var crsim_actions={
  "currency":{
    ...
    "blessed":{"desc":"Randomises the numeric values of the implicit properties of an item","name":"Blessed Orb"},
    "divine":{"desc":"Randomises the numeric values of the random properties on an item","name":"Divine Orb"},
    "veiled":{"desc":"Reforges a rare item with new random modifiers, including a veiled modifier.","name":"Veiled Chaos Orb"},
    "woke":{"desc":"Destroys an item, applying its influence to another of the same item class. The second item is reforged as a rare item with both influence types and new modifiers","name":"Awakener's Orb"},
    "maven":{"desc":"Removes one Influenced Modifier from an item with at least two Influenced Modifiers and upgrades another Influenced Modifier","name":"Orb of Dominance"},
    "fracturing":{"desc":"Fracture a random modifier on a rare item with at least 4 modifiers, locking it in place.","name":"Fracturing Orb"},
    "vaal":{"desc":"Corrupts an item, modifying it unpredictably","name":"Vaal Orb"},
  },
  "actions":{
    "recombinate":{"name":"Recombinate","desc":"Destroys two items to create a new item with a combination of their properties. Sometimes, the resultant item is modified unpredictably","img":"recombinate"},
    "fossil":{"name":"Fossil","subname":"Fossils","desc":"Fossil crafting","img":"fossil_6","subset":"custom","subsel":4}, // Automatically updates resonator in relation to selection
    "harvest":{"name":"Harvest","img":"aharvest","desc":"Harvest crafting","subname":"Method","subset":{ // Augment with, Replace, Annul, Divine -> Harvest subset
      "haugment":{"name":"Add/Remove","img":"haugment","toggled":"harvestTypeChooser","desc":"Enchants an item with a new random property of a specific type<div class='hnerf_desc'>and remove another random modifier</div>"},
      "hreplace":{"name":"Replace","img":"hreplace","toggled":"harvestTypeChooser","desc":"Replaces a random property of a specific type with another one of the same type<div class='mmi'>Ignores the cannot roll caster/attack metamods for 'influence'</div>"},
      "hnonto":{"name":"Non-type to type","img":"hreplace","toggled":"harvestTypeChooser","desc":"Replaces a random property of another type with one of a specific type"},
      "hannul":{"name":"Annul","img":"hannul","toggled":"harvestTypeChooser","desc":"Removes a random modifier of a specific type"},
      "hdivine":{"name":"Divine","img":"hdivine","toggled":"harvestTypeChooser","desc":"Randomises the numeric values of the random properties of a specific type"},
      "hreroll":{"name":"Reforge","img":"hreroll","toggled":"harvestTypeChooser","desc":"Reforge a Rare item with new random modifiers, including a modifier with the selected type<div class='mmi'>Ignores the cannot roll caster/attack metamods</div>"},
      "hrerollp":{"name":"Reforge+","img":"hrerollp","toggled":"harvestTypeChooser","desc":"Reforge a Rare item with new random modifiers, including a modifier with the selected type, modifiers of the selected type are more common<div class='mmi'>Ignores the cannot roll caster/attack metamods</div>"},
      "hresist":{"name":"Resists","img":"aharvest","toggled":"harvestResistsChooser","desc":"Change a modifier that grants a certain Resistance into a similar-tier modifier that grants another Resistance"},
    ...
    "essence":{"name":"Essence","subname":"Essences","desc":"Essences","img":"essence_Horror","subset":"custom"}, // Essence type -> tier
    "catalyst":{"name":"Catalyst","subname":"Catalysts","desc":"Catalysts","img":"acatalyst","subset":"custom"},
    "beast_crafting":{"name":"Beast crafting","img":"method_imprint","desc":"Beast crafting","subname":"Method","subset":{ // prefix to suffix, suffix to prefix, imprint
      "pretosuf":{"name":"Prefix > Suffix","desc":"Remove a prefix, add a new suffix","img":"bpretsuf","isize":38},
      "suftopre":{"name":"Suffix > Prefix","desc":"Remove a suffix, add a new prefix","img":"bsuftpre","isize":38},
      "imprint":{"name":"Imprint","desc":"Create an imprint of a magic item","img":"bimprint"},
      "breroll":{"name":"Reroll values","desc":"Randomises the numeric values of implicit and explicit modifiers of a rare item","img":"breroll"},
    ...
    "eldritch":{"name":"Eldritch crafting","img":"EldritchChaosOrb","desc":"Eldritch crafting","subname":"Method","subset":{
      "eldritchchaos":{"name":"Chaos","desc":"If The Searing Exarch is dominant, reroll prefix modifiers. If The Eater of Worlds is dominant, reroll suffix modifiers.<div class='mmi'>Ignores the prefixes/suffixes cannot be changed metamods</div>","img":"EldritchChaosOrb"},
      "eldritchexalt":{"name":"Exalted","desc":"If The Searing Exarch is dominant, add a prefix modifier. If The Eater of Worlds is dominant, add a suffix modifier.","img":"EldritchExaltedOrb"},
      "eldritchannul":{"name":"Annul","desc":"If The Searing Exarch is dominant, remove a prefix modifier. If The Eater of Worlds is dominant, remove a suffix modifier.","img":"EldritchOrbofAnnulment"},
      "eldritchconflict":{"name":"Orb of Conflict","desc":"Unpredictably raise the strength of one Searing Exarch or Eater of Worlds modifier on an item and lower the strength of another. Lesser modifiers that have their strength lowered will be removed.","img":"OrbofConflict"},
      "eldritchemberlesser":{"name":"Lesser Ember","desc":"Adds a Lesser Searing Exarch implicit modifier to a Body Armour, Boots, Gloves or Helmet. This replaces any existing implicit modifiers other than Eater of Worlds implicit modifiers.","img":"LesserEldritchEmber"},
      "eldritchembergreater":{"name":"Greater Ember","desc":"Adds a Greater Searing Exarch implicit modifier to a Body Armour, Boots, Gloves or Helmet. This replaces any existing implicit modifiers other than Eater of Worlds implicit modifiers.","img":"GreaterEldritchEmber"},
      "eldritchembergrand":{"name":"Grand Ember","desc":"Adds a Grand Searing Exarch implicit modifier to a Body Armour, Boots, Gloves or Helmet. This replaces any existing implicit modifiers other than Eater of Worlds implicit modifiers.","img":"GrandEldritchEmber"},
      "eldritchemberexceptional":{"name":"Exceptional Ember","desc":"Adds a Exceptionnal Searing Exarch implicit modifier to a Body Armour, Boots, Gloves or Helmet. This replaces any existing implicit modifiers other than Eater of Worlds implicit modifiers.","img":"ExceptionalEldritchEmber"},
      "eldritchichorlesser":{"name":"Lesser Ichor","desc":"Adds a Lesser Eater of Worlds implicit modifier to a Body Armour, Boots, Gloves or Helmet. This replaces any existing implicit modifiers other than Searing Exarch implicit modifiers.","img":"LesserEldritchIchor"},
      "eldritchichorgreater":{"name":"Greater Ichor","desc":"Adds a Greater Eater of Worlds implicit modifier to a Body Armour, Boots, Gloves or Helmet. This replaces any existing implicit modifiers other than Searing Exarch implicit modifiers.","img":"GreaterEldritchIchor"},
      "eldritchichorgrand":{"name":"Grand Ichor","desc":"Adds a Grand Eater of Worlds implicit modifier to a Body Armour, Boots, Gloves or Helmet. This replaces any existing implicit modifiers other than Searing Exarch implicit modifiers.","img":"GrandEldritchIchor"},
      "eldritchichorexceptional":{"name":"Exceptional Ichor","desc":"Adds a Exceptionnal Eater of Worlds implicit modifier to a Body Armour, Boots, Gloves or Helmet. This replaces any existing implicit modifiers other than Searing Exarch implicit modifiers.","img":"ExceptionalEldritchIchor"}
    }},
    "scourge":{"name":"Scourge crafting","img":"tainted_exalt","desc":"Scourge crafting","subname":"Method","subset":{
      "scourgetogglecorrupt":{"name":"Corruption","desc":"Force a swap from corrupted to uncorrupted or vice-versa","img":"method_vaal"},
      "scourgettexalt":{"name":"Tainted Exalted Orb","desc":"Unpredictably adds or removes a modifier on a corrupted rare item","img":"tainted_exalt"},
      "scourgettdivine":{"name":"Tainted Divine Teardrop","desc":"Unpredictably raises or lowers the tier of each modifiers on a corrupted rare item","img":"tainted_divine"}
    }},
    "corruption_altar":{"name":"Locus of Corruption","desc":"Potently corrupts an item, modifying it drastically and unpredictably","img":"locus","isize":66}, // Double corrupt
    "syndicate":{"name":"Syndicate","img":"sim_syndicate","desc":"Syndicate","subname":"Method","subset":{
      "aisling":{"name":"Aisling Veil","desc":"Replace a random modifier on a rare item with a veiled modifier<div class='mmi'>Unveil ignores the cannot roll caster/attack metamods</div>","img":"aisling"},
      "leoslam":{"name":"Leo Slam","desc":"Enchants a rare item with a new random property","img":"leoslam"}
    }},
    "vendor":{"name":"Vendor recipees","subname":"Vendor recipees","desc":"Vendor recipees","img":"vendor","subset":"custom"}
  }
};
...
function poec_openCraftingSim(){
  if($("#poecCraftingSim").length==0){
    ...
    if(crsim_skipinitimeout){
      ...
      setTimeout(function(){poec_emuInitLoad();},1); 
    }
  }else{
...
function poec_emuInitLoad(){
  ...
  vHTML="";
  var addenabled="";
  if(crsim_hnerf){addenabled=" enabled";}
  ...
  $.each(crsim_actions["currency"],function(acode,asets){
    if(asets["disabled"]==undefined){
      ...
      if(crsim_actions["currency"][acode]["noready"]){var addcls=" not_ready";}else{var addcls="";}
  ...
  $.each(crsim_actions["actions"],function(acode,asets){
    ...
    if(crsim_actions["actions"][acode]["noready"]){var addcls=" not_ready";}else{var addcls="";}
  ...
  $.each(crsim_actions["actions"],function(acode,asets){
    switch(acode){
      case 'recombinate' : crsim_spending["actions"][acode]=0; break;
      default : crsim_spending["actions"][acode]={}; break;
    }
    if(asets["subset"]!=undefined){
        ...
        switch(acode){
            ...
            $.each(crsim_vendor,function(key,vals){
              ...
              if(vals["subset"]!=undefined){
                ...
                for(var i=0;i<vals["subset"]["choices"].length;i++){
                  if(i==0){var sel=" sel";}else{var sel="";}
          ...
          case 'essence' :
            ...
            for(var i=0;i<poecd['essences']['seq'].length;i++){
              ...
              newset[poecd['essences']['seq'][i]["id_essence"]]={"name":poecl["essence"][poecd['essences']['seq'][i]["id_essence"]],"img":"essence_"+poecd['essences']['seq'][i]["name_essence"]};
            }
            asets["subset"]=newset;
          break;
          case 'catalyst' :
            ...
            for(var i=0;i<poecd['catalysts']['seq'].length;i++){
              ...
              newset[poecd['catalysts']['seq'][i]["id_catalyst"]]={"name":poecl["catalyst"][poecd['catalysts']['seq'][i]["id_catalyst"]],"img":"catalyst_"+poecd['catalysts']['seq'][i]["id_catalyst"],"desc":applyLang(crsim_catadesc[poecd['catalysts']['seq'][i]["id_catalyst"]])};
            }
            asets["subset"]=newset;
          break;
          case 'fossil' :
            ...
            for(var i=0;i<poecd['fossils']['seq'].length;i++){
              if(crsim_nofossil.indexOf("|"+poecd['fossils']['seq'][i]["id_fossil"]+"|")>-1){}else{
                ...
                newset[poecd['fossils']['seq'][i]["id_fossil"]]={"name":poecl["fossil"][poecd['fossils']['seq'][i]["id_fossil"]],"img":"fossil_"+poecd['fossils']['seq'][i]["id_fossil"],"desc":desc};
              }
            }
            newset["gilded"]={"name":applyLang("Gilded"),"img":"fossil_gilded","desc":applyLang("Item is overvalued by vendors")};
            newset["perfect"]={"name":applyLang("Perfect"),"img":"fossil_perfect","desc":applyLang("Improved Quality")};
            newset["tangled"]={"name":applyLang("Tangled"),"img":"fossil_tangled","desc":applyLang("Can have any Fossil modifiers")};
      ...
      if(asets["subsel"]!=undefined){var addcls="subsel";}else{var addcls="";}
      ...
      $.each(asets["subset"],function(scode,ssets){
        ssets["enabled"]=true;
        if(isfirst==1){var addcls=" sel";isfirst=0;}else{var addcls="";}
        if(ssets["img"]!=undefined){var img="<div class='icon'><img src='images/manual/"+ssets["img"]+".png'/></div>";addcls+=" iconed";}else{var img="";}
  ...
  $("#contentCurtain").click(function(){poec_closeCraftingSim();});
  $("#poecCraftingSim").html(vHTML);
  $("#simItemHoverer").removeClass("capply").hover(function(){poec_simCApply();poec_simChangeCursor();},function(){poec_simRestoreCursor();});
  ...
  $("#poecCraftingSim").find("div.currency").children("div").hover(function(){
    ...
    $("#poecSimHoverer").css({"margin-left":0,"top":hpos.top+$(this).outerHeight(),"left":hpos.left}).html(applyLang(crsim_actions["currency"][acode]["desc"])+poec_simCheckReasons(acode)).show();
  },function(){
    $("#poecSimHoverer").hide();
  });
  $("#poecCraftingSim").find("div.abtn:not(.ss)").hover(function(){
    ...
    switch(atype){
      case "actions":var code=$(this).attr("acode");var desc=crsim_actions[atype][code]["desc"]+poec_simCheckReasons(code);break;
      case "subset":
        var code=$(this).attr("scode");
        var desc=crsim_actions["actions"][crsim_params["action"]]["subset"][code]["desc"];
        switch(crsim_params["action"]){
          case 'fossil' : desc+=poec_simCheckReasons("fossil"+code); break;
          case 'beast_crafting' :  desc+=poec_simCheckReasons(crsim_params["action"]+code); break;
          case 'syndicate' :  desc+=poec_simCheckReasons(crsim_params["action"]+code); break;
          case 'vendor' : desc+=poec_simCheckReasons(crsim_params["action"]+code); break;
          default : desc+=poec_simCheckReasons(code); break;
        }
      break;
      case "imprint":var desc=applyLang("Apply imprint");break;
      case 'ssubset' : 
    ...
    if(desc){
      $("#poecSimHoverer").css({"margin-left":0,"top":hpos.top+$(this).outerHeight(),"left":hpos.left}).html(applyLang(desc)).show();
      if(atype=="actions"){
        if($("#crsimActions").children("div.abtn").length-$(this).index()<3){
          var tmpleft=$("#poecSimHoverer").offset().left;
          $("#poecSimHoverer").css({"left":0});
          $("#poecSimHoverer").css({"left":tmpleft,"margin-left":0-$("#poecSimHoverer").outerWidth()+$(this).outerWidth()});
        }
      }
    }
  },function(){
  ...
  $("#crsimOriginalIS").hover(function(){poec_simShowHistoryState(this);},function(){poec_simHideHistoryState();});
...
function poec_initMPSearcher(){
  ...
  $("#crsimMPSearchInput").focus(function(){
    ...
    poec_simmpstm=setTimeout(function(){poec_simMPSearchGO();},250);
  });
}
...
function poec_simMPSearchGO(){
  ...
  if(val==""){
    ...
    $("#crsimModpoolZone").find(".affix.stmgrp").each(function(){
      ...
      var pass=true;
      for(var i=0;i<vals.length;i++){
          if(search.indexOf(vals[i])>-1){}else{
              pass=false;
          }
      }
      if(pass){
...
function poec_initAffContext(){
  if($("#poecSAffContext").length==0){
    ...
    $("#poecSAffContext").hover(function(){},function(){poec_simCloseAffixContext();});
  }
}
        ...
        if(mvdata["mtypes"].length>1){
          ...
          for(var z=0;z<amtypes.length;z++){
            if(poecd["mtypes"]["seq"][poecd["mtypes"]["ind"][amtypes[z]]]["jewellery_tag"]==0){
              if(crsim_igntypes.indexOf("|"+amtypes[z]+"|")>-1){}else{
          ...
          if(crsim_actions["actions"][crsim_params["action"]]["subsel"]!=undefined){
            if(crsim_params["subaction"]!=undefined){
              if(crsim_params["subaction"].length>0){
                switch(crsim_params["action"]){
                  case 'fossil' :
                    if(crsim_settings["rarity"]=="normal"){var ir="n";}else{var ir="r";}
...
function poec_simRestart(delta,init){
  ...
  if(init){
    $("#simRestartBtn").mcuiNotice({text:applyLang("You will lose current project<br/>are you sure you wish to proceed?"),type:"confirm",complete:function(delta){poec_simRestart(delta,false);}}).showNotice();
  }else{
    if(delta==true){
      crsim_settings=null;
      crsim_log=null;
...
function poec_simGoToStep(step){
  ...
  switch(step){
    ...
    case 5 :
      ...
      if(crsim_settings["ilvl"]==null){crsim_settings["ilvl"]=100;}
      ...
      if(crsim_settings["quality"]==undefined){crsim_settings["quality"]=20;}
...
function poec_simShowItemImporter(type){
  ...
  $("#poecSimWoker").show().css({"margin-left":0-($("#poecSimWoker").outerWidth()/2),"margin-top":0-($("#poecSimWoker").outerHeight()/2)});
}
  ...
  if(pass){
    ...
    if(recomb_success){
      ...
      if(bfound){
        // Log
        if(!crsim_bypass){
          var craftDetail={"add":null,"upg":null,"rem":null,"sts":null,"det":null,"nums":1,"ilvl":crsim_settings["ilvl"],"quality":crsim_settings["quality"],"bitem":crsim_settings["bitem"],"base":crsim_settings["base"],"bgroup":crsim_settings["bgroup"],"destroyed":crsim_settings["destroyed"],"corrupted":crsim_settings["corrupted"],"rarity":crsim_settings["rarity"],"imprint":null,"catalyst":jQuery.parseJSON(JSON.stringify(crsim_catalyst)),"influences":jQuery.parseJSON(JSON.stringify(crsim_settings["influences"])),"affixes":jQuery.parseJSON(JSON.stringify(crsim_data["iaffixes"])),"eldritch":jQuery.parseJSON(JSON.stringify(crsim_data["eldritch"])),"implicits":jQuery.parseJSON(JSON.stringify(crsim_data["implicits"])),"psn":{"prefix":crsim_data["iaffbt"]["prefix"],"suffix":crsim_data["iaffbt"]["suffix"]}};
        ...
        switch(parseInt(usebitem)){
          case 8209 : usemaxaff={"prefix":2,"suffix":4}; break; // Cogwork
          case 8224 : usemaxaff={"prefix":4,"suffix":2}; break; // Geodesic
          case 8246 : usemaxaff={"prefix":2,"suffix":2}; break; // Simplex
        }
              ...
              if(woke_data["data"]["iaffixes"]){
                ...
                if(dinfmods.length>0){
                  ...
                  if(nvcombs.length>0){
                    ...
                    poec_simWokePick={"m1":jQuery.parseJSON(JSON.stringify(useaffixes[nvcombs[rndpick]["m1"]])),"m2":jQuery.parseJSON(JSON.stringify(dinfmods[nvcombs[rndpick]["m2"]]))};
                    if(!crsim_bypass){
...
function poec_simUseCurrentSettings(){
  ...
  if(poec_cImps){
    $.each(poec_cImps,function(modid,tilvl){
      ...
      if(tilvl!=null){
        if(!crsim_crsets["eldritch"]){crsim_crsets["eldritch"]={};}
...
function poec_simSetIniDisabled(imported){
        ...
        if(poecd['tiers'][etiers[crsim_settings["base"]]]){
          if(poecd['tiers'][etiers[crsim_settings["base"]]][crsim_settings["base"]]){
            ...
            for(var j=0;j<poecd['tiers'][etiers[crsim_settings["base"]]][crsim_settings["base"]].length;j++){
              if(j==ntiers-1){var addsel="sel";}else{var addsel="";}
  ...
  if(crsim_recombgroups.indexOf("|"+crsim_settings["bgroup"]+"|")>-1){}else{
  ...
  switch(parseInt(crsim_settings["bgroup"])){
    case 10 : crsim_params["disabled"]+="vaal|corruption_altar|";
    poec_simApplyPReason(applyLang("Base has no corrupted mods"),["vaal","corruption_altar"]);
    break;
    case 11 : crsim_params["disabled"]+="corruption_altar|";
    poec_simApplyPReason(applyLang("Cannot use corruption altar"),["corruption_altar"]);
    break;
    case 14 : crsim_params["disabled"]+="harvest|vaal|corruption_altar|";
    ...
    break;
    case 13 : crsim_params["disabled"]+="vaal|corruption_altar|";
    poec_simApplyPReason(applyLang("Base cannot be corrupted"),["vaal","corruption_altar"]);
    break;
  }
...
function poec_simBuildIntBase(crsim_crsets,imported){
  ...
  $.each(crsim_dreasons,function(code,artbl){crsim_dreasons[code]=[];});
  $.each(crsim_preasons,function(code,artbl){crsim_preasons[code]=[];});
  ...
  switch(parseInt(crsim_settings["bitem"])){
    case 8209 : crsim_data["maxaffgrp"]={"prefix":2,"suffix":4}; break; // Cogwork
    case 8224 : crsim_data["maxaffgrp"]={"prefix":4,"suffix":2}; break; // Geodesic
    case 8246 : crsim_data["maxaffgrp"]={"prefix":2,"suffix":2}; break; // Simplex
    case 8201 : crsim_settings["influences"]=[2,3,4,5,6,7]; break; // Astrolabe
  }

  crsim_data["cmaxaffgrp"]=crsim_data["maxaffgrp"];

  crsim_opened={"mp":{"prefix":null,"suffix":null},"cb":{"prefix":null,"suffix":null},"im":{"eldritch_red":null,"eldritch_blue":null,"corrupted":null}};
...
function poec_setItemOutputInfluence(){
  ...
  if(crsim_settings["influences"]!==null){
    ...
    if(crsim_data["eldritch"]){
      var lmgpr="red";
      var rmgpr="blue";
      if(crsim_data["eldritch"]["eldritch_red"]>0&&crsim_data["eldritch"]["eldritch_blue"]>0){}else{
  ...
  */
  ...
  if(idata["affixes"]){
    ...
    for(var i=0;i<idata["affixes"].length;i++){
      if(idata["affixes"][i]["id"]>0){
        ...
        // Mgroup info
        if(idata["affixes"][i]["mgrp"]!=1){var mgroup=" \""+poecd["mgroups"]["seq"][poecd["mgroups"]["ind"][idata["affixes"][i]["mgrp"]]]["name_mgroup"]+"\"";}else{var mgroup="";}
        // Tags info
        var tags=poec_simParseAffixMTypes(mtypes);
        var ihtml="";
  ...
  if(idata["influences"]!==null){
    ...
    if(idata["eldritch"]){
      var lmgpr="red";
      var rmgpr="blue";
      if(idata["eldritch"]["eldritch_red"]>0&&idata["eldritch"]["eldritch_blue"]>0){}else{
...
function poec_simParseIAType(atype){
  switch(atype){
    case 'eldritch_blue' : return "Eater of Worlds"; break;
    case 'eldritch_red' : return "Searing Exarch"; break;
    case 'corrupted' : return "Corrupted"; break;
  }
}
...
var crsim_ipsex=[{"from":"#% increased Armour, Evasion and Energy Shield","to":"#% increased Armour| Evasion and Energy Shield"}];
...
function poec_updateItemAffixes(){
  ...
  if(crsim_settings["destroyed"]==1){
    ...
    if(props!="[]"){
      ...
      props=jQuery.parseJSON(props);
      $.each(props,function(name,value){
        if(name=="physical_damage_min"){haspdps=true;}
        iinfo+=poec_parseItemProperty(name,value,props,quality,propmods,false);
    ...
    if(crsim_data["iaffixes"]){
      var affbytype={"prefix":"","suffix":"","crafted":"","veiled":""};
      var othmod=0;
      if(crsim_settings["bitem"]==8246){othmod=0.25;}
      for(var i=0;i<crsim_data["iaffixes"].length;i++){
        ...
        if(crsim_data["iaffixes"][i]["id"]>0){
          ...
          // Mgroup info
          if(crsim_data["iaffixes"][i]["mgrp"]!=1){var mgroup=" \""+poecd["mgroups"]["seq"][poecd["mgroups"]["ind"][crsim_data["iaffixes"][i]["mgrp"]]]["name_mgroup"]+"\"";}else{var mgroup="";}
          // Tags info
          var tags=poec_simParseAffixMTypes(mtypes);
          var ihtml="";
  ...
  // Clipboard
  if(vclprop!=""){vCLIP+=vclprop.replace("Energy shield","Energy Shield").replace("Evasion","Evasion Rating")+"--------\n";}
  if(vclreqs!=""){vCLIP+="Requirements:\n"+vclreqs+"--------\n";}
  vCLIP+="Item Level: "+crsim_settings["ilvl"]+"\n"+"--------\n";
  if(vclimps!=""){vCLIP+=vclimps+"--------\n";}
  if(vclaffs!=""){vCLIP+=vclaffs+"--------\n";}
  if(crsim_settings["influences"]){
    ...
    if(mtypes.length>1){
      ...
      for(var i=0;i<amtypes.length;i++){
        if(poecd["mtypes"]["seq"][poecd["mtypes"]["ind"][amtypes[i]]]["jewellery_tag"]==0){
          if(crsim_igntypes.indexOf("|"+amtypes[i]+"|")>-1){}else{
  ...
  */
  ...
  if(crsim_settings["influences"]!=null){
    ...
    if(!crsim_data["eldritch"]){
      ...
      if(crsim_data["eldritch"]["eldritch_blue"]>0&&crsim_data["eldritch"]["eldritch_red"]>0){}else{
  ...
  if(!Array.isArray(crsim_data["iaffixes"])){crsim_data["iaffixes"]=[];}
...
function poec_simApplyCraftGO(forced,override,nolog){
  ...
  if(forced){
    if(forced["bench"]==true){
      ...
      var hasveiled=false;
      for(var i=0;i<crsim_data["iaffixes"].length;i++){
        if(crsim_data["iaffixes"][i]["id"]>0){}else{
          hasveiled=true;
        }
      }
      if(hasveiled){
    ...
    switch(crafts["mode"]){
      case 'currency' :
        ...
        if(cpass){
          switch(usecurrency){
            case 'transmute' : poec_simSetRarity("magic"); poec_simRerollItem("magic",null,null,null,false,false,false,false,null,false,false,false,false); break;
            case 'alteration' : poec_simRerollItem("magic",null,null,null,false,false,false,true,null,false,false,false,false); break;
            case 'augmentation' : craftDetail["add"]=poec_simRollAffix(null,null,null,null,1,true,true,false,false,false,false,null,false); poec_remCatQuality(2); break;
            case 'regal' : poec_simSetRarity("rare"); craftDetail["add"]=poec_simRollAffix(null,null,null,null,1,true,true,false,false,false,false,null,false); poec_remCatQuality(5); break;
            case 'alchemy' : poec_simSetRarity("rare"); poec_simRerollItem("rare",null,null,null,false,false,false,false,null,false,false,false,false); break;
            case 'chaos' : poec_simRerollItem("rare",null,null,null,false,false,false,true,null,false,false,false,false); break;
            case 'exalted' : 
            ...
            break;
            case 'scour' : poec_simClearItem(true); break;
            case 'annul' : craftDetail["rem"]=poec_simRemoveAffix(null,null,null,true,false,true,false,true,null); poec_remCatQuality(20); break;
            case 'vaal' : craftDetail["sts"]=poec_simCorrupt(crsim_vaaltbl,crafts); break;
            case 'crusader' : poec_simAddInfluence(4); craftDetail["add"]=poec_simRollAffix(4,null,null,null,1,true,true,false,false,false,false,null,false); poec_remCatQuality(20); break;
            case 'redeemer' : poec_simAddInfluence(7); craftDetail["add"]=poec_simRollAffix(7,null,null,null,1,true,true,false,false,false,false,null,false); poec_remCatQuality(20); break;
            case 'hunter' : poec_simAddInfluence(5); craftDetail["add"]=poec_simRollAffix(5,null,null,null,1,true,true,false,false,false,false,null,false); poec_remCatQuality(20); break;
            case 'warlord' : poec_simAddInfluence(6); craftDetail["add"]=poec_simRollAffix(6,null,null,null,1,true,true,false,false,false,false,null,false); poec_remCatQuality(20); break;
            case 'blessed' : craftDetail["sts"]=poec_simRerollImplicits(false); break;
            case 'divine' : craftDetail["sts"]=poec_simRerollValues(null,null,false); break;
            case 'fracturing' : 
                ...
                if(useaffixes[i]["modgroups"]){
                  for(var zy=0;zy<useaffixes[i]["modgroups"].length;zy++){
                    switch(useaffixes[i]["modgroups"][zy]){
                      case 'ItemGenerationCannotChangePrefixes' : haslock["prefix"]=true; break;
                      case 'ItemGenerationCannotChangeSuffixes' : haslock["suffix"]=true; break;
                    }
                  }
                }
              }
        ...
        switch(crafts["action"]){
          ...
          case 'essence' :
            ...
            if(efail){
              ...
              poec_simRerollItem("rare",null,[{"mod":usecuressmod,"tier":etier}],null,false,false,false,false,null,false,false,false,false);
              if(!override){
          ...
          case 'catalyst' :
            ...
            var cinc=5;
            switch(userarity){
              case 'magic' : cinc=2; break;
              case 'rare' : cinc=1; break;
            }
            var numused=1;
            ...
            if(usecatalyst){
              if(usecatalyst["id"]==crafts["subaction"]){
                if(usecatalyst["val"]>=20){
                  ...
                  if(usecatalyst["val"]>=20){usecatalyst["val"]=20;}
                }
              }else{
                rstcata=true;
              }
                    ...
                    switch(crafts["subaction"][m]){
                      case '20' : // Glyphic
                        ...
                        if(glyphs.length==0){
                          ...
                          if(affix){
                            addmods=[{"mod":glyphs[affix["index"]]["id_modifier"],"tier":0}];
                          }else{
          ...
          case 'harvest' :
            ...
            if(success!==false){
              ...
              switch(crafts["subaction"]){
                case 'hreroll' : poec_simRerollItem(rerollto,null,null,null,false,crafts["ssaction"],false,true,null,false,true,false,false); break;
                case 'hrerollp' : poec_simRerollItem(rerollto,null,null,null,false,crafts["ssaction"],true,true,null,false,true,false,false); break;
                case 'haugment' : 
                ...
                break;
                case 'hannul' : craftDetail["rem"]=poec_simRemoveAffix(crafts["ssaction"],null,null,true,false,false,false,false,null); break;
                case 'hdivine' : craftDetail["sts"]=poec_simRerollValues(crafts["ssaction"],null,false); break;
                case 'hnonto' :
                  //console.log(success);
                ...
                case 'hother' :
                  switch(crafts["ssaction"]){
                    case 'hrepf' : poec_simRerollItem(rerollto,null,null,null,false,false,false,true,"suffix",false,false,false,false); break;
                    case 'hresf' : poec_simRerollItem(rerollto,null,null,null,false,false,false,true,"prefix",false,false,false,false); break;
                    case 'rfmlk' : poec_simRerollItem(rerollto,null,null,null,false,false,false,true,false,false,true,false,1); break;
                    case 'rfllk' : poec_simRerollItem(rerollto,null,null,null,false,false,false,true,false,false,true,false,2); break;
                    case 'hrrvpsi' : craftDetail["sts"]=poec_simRerollValues(null,{"prefix":true,"suffix":true,"implicit":true},true); break;
                    case 'hrrvp' : craftDetail["sts"]=poec_simRerollValues(null,{"prefix":true,"suffix":false,"implicit":false},true); break;
                    case 'hrrvs' : craftDetail["sts"]=poec_simRerollValues(null,{"prefix":false,"suffix":true,"implicit":false},true); break;
                  }
                break;
                case 'hhight' : 
                  switch(crafts["ssaction"]){
                    case 'htnmo' : poec_simSetRarity("magic"); poec_simRollAffix(null,null,null,null,1,true,true,false,false,false,false,null,true); break;
                    case 'htnmt' : poec_simSetRarity("magic"); poec_simRollAffix(null,null,null,null,2,true,true,false,false,false,false,null,true); break;
                    case 'htmrt' : poec_simSetRarity("rare"); poec_simRollAffix(null,null,null,null,2,true,true,false,false,false,false,null,true); break;
                    case 'htmrr' : poec_simSetRarity("rare"); poec_simRollAffix(null,null,null,null,3,true,true,false,false,false,false,null,true); break;
                    case 'htmrf' : poec_simSetRarity("rare"); poec_simRollAffix(null,null,null,null,4,true,true,false,false,false,false,null,true); break;
                  }
                break;
                case 'hresist' :
                  ...
                  if(loaff>1){
                    ...
                    if(rolled<15){
                      ...
                      if(veiltype==null){
                        // Roll 50/50
                        var rolled=poec_rand(0,2,true);
                        if(rolled==1){veiltype="prefix";}else{veiltype="suffix";}
          ...
          case 'eldritch' : 
            ...
            switch(crafts["subaction"]){
              ...
              break;
              case 'eldritchemberlesser': poec_simAddEldritchImplicit("eldritch_red",6); break;
              case 'eldritchembergreater': poec_simAddEldritchImplicit("eldritch_red",5); break;
              case 'eldritchembergrand': poec_simAddEldritchImplicit("eldritch_red",4); break;
              case 'eldritchemberexceptional': poec_simAddEldritchImplicit("eldritch_red",3); break;
              case 'eldritchichorlesser': poec_simAddEldritchImplicit("eldritch_blue",6); break;
              case 'eldritchichorgreater': poec_simAddEldritchImplicit("eldritch_blue",5); break;
              case 'eldritchichorgrand': poec_simAddEldritchImplicit("eldritch_blue",4); break;
              case 'eldritchichorexceptional': poec_simAddEldritchImplicit("eldritch_blue",3); break;
            }
            if(success&&!override){
              ...
              switch(crafts["subaction"]){
                default:
                  ...
                  if(result["mods"]){
                        ...
                        if(cmtindex!=null){
                          ...
                          if(tdiff>=parseInt(result["mods"][y]["maxtier"])){
                            ...
                            if(parseInt(nextilvl)>crsim_settings["ilvl"]){
                              ...
                              vaffs.push({"id":result["mods"][y]["id"],"tindex":nexttier});
                            }
                          }else{
                            // Fail by max tier
                            vfail=true;
                    ...
                    if(vfail){
                      $("#simItemHoverer").mcuiNotice({text:applyLang(verror),type:"alert"}).showNotice();
...
function poec_simRerollItem(rarity,fossil,affs,forcenum,remfrac,forcetag,tagplus,metaprot,keepside,woke,igcrca,veiled,rfmlk){
  ...
  if(rfmlk){
    ...
    if(usemaxaffgrp["prefix"]==2){
      if(forcenum<3){forcenum=3;}
    }else{
      if(forcenum<4){forcenum=4;}
    }
    for(var i=0;i<useaffixes.length;i++){
      if(useaffixes[i]["id"]>0){
  ...
  if(veiled){
    ...
    var blksf=false;
    var veiltype=false;
    if(useaffbt["prefix"]>=usemaxaffgrp["prefix"]){blkpr=true;}
    if(useaffbt["suffix"]>=usemaxaffgrp["suffix"]){blksf=true;}
    if(blkpr){
      if(blksf){
        // No space
...
function poec_simGetBlockData(){
  ...
  if(useaffbt["prefix"]>=usecmaxaffgrp["prefix"]){blktype["prefix"]=true;}
  if(useaffbt["suffix"]>=usecmaxaffgrp["suffix"]){blktype["suffix"]=true;}

  // Check if we have reach ult max
  var blkutype={"prefix":false,"suffix":false};
  if(useaffbt["prefix"]>=usemaxaffgrp["prefix"]){blkutype["prefix"]=true;}
  if(useaffbt["suffix"]>=usemaxaffgrp["suffix"]){blkutype["suffix"]=true;}
  ...
  var blkdata={"blkmgroups":blkmgroups,"blktype":blktype,"blkutype":blkutype,"vmgroups":vmgroups,"amgs":blkamg};
  return blkdata;
}
...
function poec_simRollAffix(mgroup,tag,atype,fossil,numroll,meta,apcat,enforcetag,igcrca,rfmlk,rfmlkt,rfmlkv,hightier){
  ...
  var blktags=[];
  if(meta&&!igcrca){
    if(usemetas["no_attack"]){blktags.push("3");}
    if(usemetas["no_caster"]){blktags.push("13");}
  }
  ...
  if(sfail||useaffixes.length>=usemaxaffgrp["prefix"]+usemaxaffgrp["suffix"]){
    ...
    for(var m=0;m<numroll;m++){
      if(m>0){
        ...
        var blktype={"prefix":false,"suffix":false};
        if(useaffbt["prefix"]>=usemaxaffgrp["prefix"]){blktype["prefix"]=true;}
        if(useaffbt["suffix"]>=usemaxaffgrp["suffix"]){blktype["suffix"]=true;}
        var nmodpool=[];
        crsim_tweight=0;
...
function poec_simRemoveAffix(tag,atype,mgroup,meta,nonto,apcat,ruleout,nocnoa,fixedset){
  ...
  if(meta){
    if(usemetas["nchg_pre"]){keep["prefix"]=true;}
    if(usemetas["nchg_suf"]){keep["suffix"]=true;}
  }
  if(nocnoa){
    if(usemetas["no_attack"]){keep["attack"]=true;}
    if(usemetas["no_caster"]){keep["caster"]=true;}
  }
  var relig=[];
  var tewght=0;
  if(fixedset!==null){
          ...
          if(!keep[useaffixes[i]["atype"]]&&useaffixes[i]["frac"]==0){
            ...
            if(contok){
              ...
              if(nonto){
                if(useaffixes[i]["id"]>0){
                  if(tag=="inf"){
                    if(crsim_infgrps.indexOf("|"+useaffixes[i]["mgrp"]+"|")>-1){}else{tewght+=prvweight;relig.push({"i":i,"w":prvweight});}
                  }else{
                    if(useaffixes[i]["maven"]){
                      if(crsim_mvdata[useaffixes[i]["maven"]]["strcheck"].indexOf("|"+tag+"|")>-1){}else{tewght+=prvweight;relig.push({"i":i,"w":prvweight});}
                    }else{
                      if(usemtypes[useaffixes[i]["id"]]["strcheck"].indexOf("|"+tag+"|")>-1){}else{tewght+=prvweight;relig.push({"i":i,"w":prvweight});}
                    }
                  }
                }else{
                  tewght+=prvweight;relig.push({"i":i,"w":prvweight});
                }
              }else{
                if(tag=="inf"){
                  if(crsim_infgrps.indexOf("|"+useaffixes[i]["mgrp"]+"|")>-1){tewght+=prvweight;relig.push({"i":i,"w":prvweight});}
                }else{
                  if(useaffixes[i]["maven"]){
                    if(crsim_mvdata[useaffixes[i]["maven"]]["strcheck"].indexOf("|"+tag+"|")>-1){tewght+=prvweight;relig.push({"i":i,"w":prvweight});}
                  }else{
                    if(usemtypes[useaffixes[i]["id"]]["strcheck"].indexOf("|"+tag+"|")>-1){tewght+=prvweight;relig.push({"i":i,"w":prvweight});}
                  }
                }
              }
            }
...
function poec_simRerollValues(tag,what,lucky){
  ...
  for(var i=0;i<useaffixes.length;i++){
    ...
    if(tag){
      if(useaffixes[i]["maven"]){
        if(crsim_mvdata[useaffixes[i]["maven"]]["strcheck"].indexOf("|"+tag+"|")>-1){}else{
          ivalid=false;
        }
      }else{
        if(usemtypes[useaffixes[i]["id"]]["strcheck"].indexOf("|"+tag+"|")>-1){}else{
          ivalid=false;
        }
      }
    }
...
function poec_simSetRarity(rarity){
  if(crsim_bypass){
    ...
    switch(rarity){
      case 'normal' : crsim_bypass["cmaxaffgrp"]={"prefix":0,"suffix":0}; break;
      case 'magic' : crsim_bypass["cmaxaffgrp"]={"prefix":1,"suffix":1}; break;
      case 'rare' : crsim_bypass["cmaxaffgrp"]=crsim_bypass["maxaffgrp"]; break;
    }
  }else{
    crsim_settings["rarity"]=rarity;
    switch(rarity){
      case 'normal' : crsim_data["cmaxaffgrp"]={"prefix":0,"suffix":0}; break;
      case 'magic' : crsim_data["cmaxaffgrp"]={"prefix":1,"suffix":1}; break;
      case 'rare' : crsim_data["cmaxaffgrp"]=crsim_data["maxaffgrp"]; break;
    }
    ...
    if(validmgroup.indexOf("|"+idmgroup+"|")>-1){
      for(var j=0;j<mods.length;j++){
        ...
        if(mconflict){}else{
          ...
          if(tag){
            if(tag=="inf"){
              if(crsim_infgrps.indexOf("|"+mods[j]["id_mgroup"]+"|")>-1){}else{
                valid=false;
              }
            }else{
              if(usemtypes[mods[j]["id_modifier"]]["strcheck"].indexOf("|"+tag+"|")>-1){}else{
                valid=false;
              }
            }
          }
          ...
          if(mods[j]["id_mgroup"]==8&&crsim_fossiling){
            if(crsim_fossiling["strfossils"].indexOf("|"+mods[j]["id_fossil"]+"|")>-1){}else{
              valid=false;
            }
          }
          if(valid){
...
function poec_simBuildMPHtml(modpool,atype,ptype){
  if(modpool.length==0){
    ...
    for(var i=0;i<modpool.length;i++){
      if(lastmgrp!=modpool[i][use]){
        ...
        if(use=="mgrp"){
          ...
          switch(modpool[i][use]){
            case 'eldritch_blue' : var gname=applyLang("Eater of Worlds"); break;
            case 'eldritch_red' : var gname=applyLang("Searing Exarch"); break;
            default: var gname=applyLang("Vaal implicits"); break;
          }
        }
      ...
      if(bcls=="lt"){bcls="drk";}else{bcls="lt";}
        ...
        $.each(crsim_spending["actions"][acode],function(fcode,cnt){
          if(cnt>0){
            ...
            if(fcode.substring(0,4)=="reso"){
              ...
              var term="";
              switch(reso){
                case 1 : term="Primitive"; break;
                case 2 : term="Potent"; break;
                case 3 : term="Powerful"; break;
                case 4 : term="Prime"; break;
              }
              fname=term+" Chaotic";
      ...
      case 'beast_crafting' :
        ...
        $.each(crsim_spending["actions"][acode],function(scode,cnt){
          if(cnt>0){
            var beast_rate=0;
            switch(scode){
              case 'imprint' : beast_rate=poecp["data"][poec_cLNinja]["beasts"]["Craicic Chimeral"]; break;
              case 'pretosuf' : beast_rate=poecp["data"][poec_cLNinja]["beasts"]["Farric Wolf Alpha"]; break;
              case 'suftopre' : beast_rate=poecp["data"][poec_cLNinja]["beasts"]["Farric Lynx Alpha"]; break;
              case 'breroll' : beast_rate=poecp["data"][poec_cLNinja]["beasts"]["Farric Frost Hellion Alpha"]; break;
              case 'bcat' : beast_rate=poecp["data"][poec_cLNinja]["beasts"]["Farrul, First of the Plains"]; break;
              case 'bavian' : beast_rate=poecp["data"][poec_cLNinja]["beasts"]["Saqawal, First of the Sky"]; break;
              case 'bspider' : beast_rate=poecp["data"][poec_cLNinja]["beasts"]["Fenumus, First of the Night"]; break;
              case 'bcrab' : beast_rate=poecp["data"][poec_cLNinja]["beasts"]["Craiceann, First of the Deep"]; break;
            }
      ...
      case 'scourge' : 
        $.each(crsim_spending["actions"][acode],function(scode,cnt){
          if(cnt>0){
            var scourge_rate=0;
            switch(scode){
              case 'scourgettexalt' : scourge_rate=poecp["data"][poec_cLNinja]["currency"]["Tainted Exalted Orb"]; break;
              case 'scourgettdivine' : scourge_rate=poecp["data"][poec_cLNinja]["currency"]["Tainted Divine Teardrop"]; break;
            }
          ...
          $.each(sdata,function(sscode,cnt){
            if(cnt>0){
              switch(crsim_actions["actions"][acode]["subset"][scode]["name"]){
                ...
                case 'Hysteria' :
                case 'Delirium' :
                case 'Insanity' : var etnid=8; break;
                default : var etnid = 7-($("#crsimESSTChooser_"+scode).children(".abtn").length-parseInt(sscode)-1); break;
              }
      ...
      case 'eldritch' : 
        $.each(crsim_spending["actions"][acode],function(scode,cnt){
          if(cnt>0){
            var eldritch_rate=0;
            switch(scode){
              case 'eldritchemberexceptional' : eldritch_rate=poecp["data"][poec_cLNinja]["currency"]["Exceptional Eldritch Ichor"]; break;
              case 'eldritchichorexceptional' : eldritch_rate=poecp["data"][poec_cLNinja]["currency"]["Exceptional Eldritch Ember"]; break;
              case 'eldritchembergrand' : eldritch_rate=poecp["data"][poec_cLNinja]["currency"]["Grand Eldritch Ichor"]; break;
              case 'eldritchichorgrand' : eldritch_rate=poecp["data"][poec_cLNinja]["currency"]["Grand Eldritch Ember"]; break;
              case 'eldritchembergreater' : eldritch_rate=poecp["data"][poec_cLNinja]["currency"]["Greater Eldritch Ichor"]; break;
              case 'eldritchichorgreater' : eldritch_rate=poecp["data"][poec_cLNinja]["currency"]["Greater Eldritch Ember"]; break;
              case 'eldritchemberlesser' : eldritch_rate=poecp["data"][poec_cLNinja]["currency"]["Lesser Eldritch Ichor"]; break;
              case 'eldritchichorlesser' : eldritch_rate=poecp["data"][poec_cLNinja]["currency"]["Lesser Eldritch Ember"]; break;
              case 'eldritchconflict' : eldritch_rate=poecp["data"][poec_cLNinja]["currency"]["Orb of Conflict"]; break;
              case 'eldritchchaos' : eldritch_rate=poecp["data"][poec_cLNinja]["currency"]["Eldritch Chaos Orb"]; break;
              case 'eldritchexalt' : eldritch_rate=poecp["data"][poec_cLNinja]["currency"]["Eldritch Exalted Orb"]; break;
              case 'eldritchannul' : eldritch_rate=poecp["data"][poec_cLNinja]["currency"]["Eldritch Orb of Annulment"]; break;
            }
      ...
      if(crsim_actions["actions"][log_action["action"]]["subset"]!=undefined&&crsim_actions["actions"][log_action["action"]]["subsel"]==undefined){
        ...
        if(log_action["ssaction"]){
          ...
          switch(log_action["subaction"]){
            case 'hother' : fallback+=" - "+$("#harvestOtherChooser").find(".acss_"+log_action["ssaction"]).text(); break;
            case 'hresist' : fallback+=" - "+$("#harvestResistsChooser").find(".acss_"+log_action["ssaction"]).text(); break;
          }
          ...
          switch(log_action["subaction"]){
            case 'imprint' : fallback=applyLang("Store imprint"); break;
          }
          getcnum=crsim_spending["actions"][log_action["action"]][log_action["subaction"]];
        }
      }else{
...
function poec_simRevertHistory(){
  if(crsim_log.length>0){
    ...
    if(rlog["bitem"]!=crsim_settings["bitem"]){
      if(!rlog["bitem"]){rlog["bitem"]=crsim_settings["bitem"];}
      if(!rlog["base"]){rlog["base"]=crsim_settings["base"];}
      if(!rlog["bgroup"]){rlog["bgroup"]=crsim_settings["bgroup"];}
...
function poec_simCheckHarvestValid(){
  ...
  if(useaffbt["prefix"]>=useamaxaffgrp["prefix"]){fblktype["prefix"]=true;}
  if(useaffbt["suffix"]>=useamaxaffgrp["suffix"]){fblktype["suffix"]=true;}
  var metakeep={"prefix":false,"suffix":false};
  if(usemetas["nchg_pre"]){metakeep["prefix"]=true;}
  if(usemetas["nchg_suf"]){metakeep["suffix"]=true;}
  ...
  switch(usesubaction){
          ...
          if(useaffixes[zz]["frac"]==0){
            ...
            if(!metablock){
              if(useaffixes[zz]["id"]>0){
                if(usessaction=="inf"){
                  if(crsim_infgrps.indexOf("|"+useaffixes[zz]["mgrp"]+"|")>-1){}else{nonvalid.push(zz);}
                }else{
                  if(useaffixes[zz]["maven"]){
                    if(crsim_mvdata[useaffixes[zz]["maven"]]["strcheck"].indexOf("|"+usessaction+"|")>-1){}else{nonvalid.push(zz);}
                  }else{
                    if(usemtypes[useaffixes[zz]["id"]]["strcheck"].indexOf("|"+usessaction+"|")>-1){}else{nonvalid.push(zz);}
                  }
                }
              }else{
                nonvalid.push(zz);
            ...
            if(taffbt["prefix"]<usemaxaffgrp["prefix"]){
              for(var zy=0;zy<usehmodpool["prefix"].length;zy++){
                ...
                if(mconflict){}else{
                  ...
                  if(!blocked){
                    if(usessaction=="inf"){
                      if(crsim_infgrps.indexOf("|"+usehmodpool["prefix"][zy]["mgrp"]+"|")>-1){nvadd++;}
                    }else{
                      if(usehmodpool["prefix"][zy]["mtypes"].indexOf("|"+usessaction+"|")>-1){nvadd++;}
                    }
                  }
                }
              }
            ...
            if(taffbt["suffix"]<usemaxaffgrp["suffix"]){
              for(var zy=0;zy<usehmodpool["suffix"].length;zy++){
                ...
                if(mconflict){}else{
                  ...
                  if(!blocked){
                    if(usessaction=="inf"){
                      if(crsim_infgrps.indexOf("|"+usehmodpool["suffix"][zy]["mgrp"]+"|")>-1){nvadd++;}
                    }else{
                      if(usehmodpool["suffix"][zy]["mtypes"].indexOf("|"+usessaction+"|")>-1){nvadd++;}
                    }
                  }
                }
              }
    ...
    case 'hresist' :
      ...
      console.log(sselect);
      switch(sselect){
        case 'hrftc' : from="Fire"; to="Cold"; break;
        case 'hrftl' : from="Fire"; to="Lightning"; break;
        case 'hrctf' : from="Cold"; to="Fire"; break;
        case 'hrctl' : from="Cold"; to="Lightning"; break;
        case 'hrltf' : from="Lightning"; to="Fire"; break;
        case 'hrltc' : from="Lightning"; to="Cold"; break;
      }
                ...
                if(!alreadythere){
                  ...
                  if(crsim_resswaps[j]["bgrp"]){
                    ...
                    $.each(usefmodpool[typecheck],function(grpkey,cmods){
                      var grpvalid=true;
                      if(grpkey!=1){
                        if(iinfs.indexOf("|"+grpkey+"|")>-1){}else{
                          grpvalid=false;
                        }
                      }
                      if(grpvalid){
  ...
  if(nonto){
    for(var i=0;i<useiaffixes.length;i++){
      if(!keep[useiaffixes[i]["atype"]]&&useiaffixes[i]["frac"]==0){
        if(usessaction=="inf"){
          if(crsim_infgrps.indexOf("|"+useiaffixes[i]["mgrp"]+"|")){}else{nvalid++;}
        }else{
          if(useiaffixes[i]["maven"]){
            if(crsim_mvdata[useiaffixes[i]["maven"]]["strcheck"].indexOf("|"+usessaction+"|")>-1){}else{nvalid++;}
          }else{
            if(usemtypes[useiaffixes[i]["id"]]["strcheck"].indexOf("|"+usessaction+"|")>-1){}else{nvalid++;}
          }
        }
      }
    }
    ...
    for(var i=0;i<useiaffixes.length;i++){
      if(!keep[useiaffixes[i]["atype"]]&&useiaffixes[i]["frac"]==0){
        if(usessaction=="inf"){
          if(crsim_infgrps.indexOf("|"+useiaffixes[i]["mgrp"]+"|")){nvalid++;}
        }else{
          if(useiaffixes[i]["maven"]){
            if(crsim_mvdata[useiaffixes[i]["maven"]]["strcheck"].indexOf("|"+usessaction+"|")>-1){nvalid++;}
          }else{
            if(usemtypes[useiaffixes[i]["id"]]["strcheck"].indexOf("|"+usessaction+"|")>-1){nvalid++;}
          }
        }
      }
    }
...
function poec_simGetNumNon(atype){
  ...
  for(var i=0;i<useaffixes.length;i++){
    if(useaffixes[i]["atype"]==atype&&useaffixes[i]["frac"]==0){
      if(useaffixes[i]["id"]>0){
        if(usessaction=="inf"){
          if(crsim_infgrps.indexOf("|"+useaffixes[i]["mgrp"]+"|")>-1){}else{numnon++;}
        }else{
          if(useaffixes[i]["maven"]){
            if(crsim_mvdata[useaffixes[i]["maven"]]["strcheck"].indexOf("|"+usessaction+"|")>-1){}else{numnon++;}
          }else{
            if(usemtypes[useaffixes[i]["id"]]["strcheck"].indexOf("|"+usessaction+"|")>-1){}else{numnon++;}
          }
        }
      }else{
        numnon++;
...
function poec_simGetNumTo(atype){
  ...
  for(var i=0;i<usecmodpool[atype].length;i++){
    ...
    if(!blocked){
      if(usessaction=="inf"){
        if(crsim_infgrps.indexOf("|"+usecmodpool[atype][i]["mgrp"]+"|")>-1){numto++;}
      }else{
        if(usecmodpool[atype][i]["mtypes"].indexOf("|"+usessaction+"|")>-1){numto++;}
      }
    }
  }
...
function poec_simGetNumFromPool(atype,blk){
  ...
  for(var i=0;i<usehmodpool[atype].length;i++){
    var wouldadd=false;
    if(usessaction=="inf"){
      if(crsim_infgrps.indexOf("|"+usehmodpool[atype][i]["mgrp"]+"|")>-1){wouldadd=true;}
    }else{
      if(usehmodpool[atype][i]["mtypes"].indexOf("|"+usessaction+"|")>-1){wouldadd=true;}
    }
    if(wouldadd){
      if(blk){
...
function poec_simForceAction(vThis,ptype,affid,tindex){
  if(!crsim_lock){
    ...
    if(ptype=="im"){
      // IMPLICITS
      var craftDetail={"add":null,"upg":null,"rem":null,"sts":null,"det":null,"nums":1,"ilvl":crsim_settings["ilvl"],"quality":crsim_settings["quality"],"destroyed":crsim_settings["destroyed"],"corrupted":crsim_settings["corrupted"],"rarity":crsim_settings["rarity"],"imprint":null,"catalyst":jQuery.parseJSON(JSON.stringify(crsim_catalyst)),"influences":jQuery.parseJSON(JSON.stringify(crsim_settings["influences"])),"affixes":jQuery.parseJSON(JSON.stringify(crsim_data["iaffixes"])),"eldritch":jQuery.parseJSON(JSON.stringify(crsim_data["eldritch"])),"implicits":jQuery.parseJSON(JSON.stringify(crsim_data["implicits"])),"psn":{"prefix":crsim_data["iaffbt"]["prefix"],"suffix":crsim_data["iaffbt"]["suffix"]}};
      if(crsim_data["implicits"]){
        ...
        if(atype!="corrupted"){
          ...
          for(var i=0;i<crsim_data["implicits"].length;i++){
            ...
            switch(crsim_data["implicits"][i]["atype"]){
              case 'eldritch_blue' : 
                if(!crsim_data["eldritch"]){crsim_data["eldritch"]={};}
      ...
      if($(tierrow).hasClass("find0")){
        ...
        if($(affrow).hasClass("prtrue")){
          // Swap
          poec_simApplyCraftGO({"action":"swap","ptype":ptype,"affid":affid,"tindex":tindex,"trueswap":true},null,false);
        }else{
          ...
          if(passcraft){
            if(ptype=="cb"){
              if($("#crsimMasterModpool").hasClass("benched")&&!$("#crsimMasterModpool").hasClass("mul_mods")){
                // Bench Swap
                poec_simApplyCraftGO({"action":"swap","ptype":ptype,"affid":affid,"tindex":tindex,"trueswap":false,"bench":true},null,false);
              }else{
                if(!$("#crsimMasterModpool").hasClass("benched")){
                  // Regular add
                  poec_simApplyCraftGO({"action":"add","ptype":ptype,"affid":affid,"tindex":tindex,"bench":true},null,false);
                }else{
              ...
              poec_simApplyCraftGO({"action":"add","ptype":ptype,"affid":affid,"tindex":tindex},null,false);
            }
          }else{
            crsim_lock=false;
          }
...
function poec_simApplyImprint(){
  if(crsim_bypass){
    ...
    var craftDetail={"add":null,"upg":null,"rem":null,"sts":null,"det":null,"nums":1,"ilvl":crsim_settings["ilvl"],"quality":crsim_settings["quality"],"bitem":crsim_settings["bitem"],"base":crsim_settings["base"],"bgroup":crsim_settings["bgroup"],"rarity":crsim_settings["rarity"],"destroyed":crsim_settings["destroyed"],"corrupted":crsim_settings["corrupted"],"catalyst":jQuery.parseJSON(JSON.stringify(crsim_catalyst)),"imprint":jQuery.parseJSON(JSON.stringify(useimprint)),"eldritch":jQuery.parseJSON(JSON.stringify(crsim_data["eldritch"])),"influences":jQuery.parseJSON(JSON.stringify(crsim_settings["influences"])),"affixes":jQuery.parseJSON(JSON.stringify(crsim_data["iaffixes"])),"implicits":jQuery.parseJSON(JSON.stringify(crsim_data["implicits"])),"psn":{"prefix":crsim_data["iaffbt"]["prefix"],"suffix":crsim_data["iaffbt"]["suffix"]}};
  }
  ...
  if(data||!init){
      try{
          ...
          if(import_data["config"]){
            ...
            $("#simImportBtn").mcuiNotice({text:applyLang("This appears to be a simulator dataset!"),type:"alert"}).showNotice();
      ...
      if(pastebin){
          ...
          var acajax = new mc_ajax("../../cgi/web/custom/get_pastebin.php","url="+encodeURIComponent(pastebin),{complete:function(result){
...
function poec_simToggleFrac(vThis,affid,ptype){
  if(!crsim_settings["influences"]){
    ...
    if(foundaff>-1){
      poec_simApplyCraftGO({"action":"frac","ptype":ptype,"affid":affid,"action":"frac","tindex":foundaff,"extra":frac},null,false);
    }else{
...
function poec_simRollImplicits(num){
  ...
  if(crsim_igncorimp.indexOf("|"+usebitem+"|")>-1){}else{
...
function poec_simParsePoolFossils(selection){
  ...
  for(var i=0;i<selection.length;i++){
    if(crsim_specialfossils.indexOf("|"+selection[i]+"|")>-1){}else{
...
function poec_simAffixContextGO(action){
  ...
  switch(action){
    case 'rem' : poec_simApplyCraftGO({"action":"rem","ptype":"mp","affid":affid,"tindex":aind},null,false); break;
    case 'frac' : poec_simApplyCraftGO({"action":"frac","ptype":"mp","affid":affid,"action":"frac","tindex":aind,"extra":1},null,false); break;
    case 'ufrac' : poec_simApplyCraftGO({"action":"frac","ptype":"mp","affid":affid,"action":"frac","tindex":aind,"extra":0},null,false); break;
  }
...
function poec_simCopyToClipboard(){
  ...
  $("#simClipBtn").mcuiNotice({text:applyLang("Item copied to clipboard!<br>(Path of Building compatible)"),type:"alert"}).showNotice();
}
...
function poec_simUnveilMod(swapindex,retdata){
  ...
  for(var i=0;i<usefmodpool[useaffixes[swapindex]["atype"]][crsim_veiledmgrp].length;i++){
    ...
    if(mconflict){}else{
      ...
      if(usefmodpool[useaffixes[swapindex]["atype"]][crsim_veiledmgrp][i]["amg"]){
        ...
        if(tamgs){
          for(var h=0;h<tamgs.length;h++){
            if(blkamg.indexOf("|"+tamgs[h]+"|")>-1){amgvalid=false;}
          }
        }
      }
      if(amgvalid){
  ...
  if(!crsim_bypass){
    ...
    $("#poec_simVeilChooser").css({"margin-left":0-($("#poec_simVeilChooser").outerWidth()/2),"margin-top":0-($("#poec_simVeilChooser").outerHeight()/2),"visibility":"visible"});
    $("#poecSimWCurtain").show();
  }
