...
var poec_cpseudos = {
    ...
    "mods": {
        ...
        "#% increased Physical Damage": {
            "affects": ["physical_damage_min", "physical_damage_max", "physical_damage"],
            "type": "m",
            "mod": [1, 1, 1]
        },
        ...
        "#% increased Armour| Evasion and Energy Shield": {
            "affects": ["armour", "evasion", "energy_shield"],
            "type": "m",
            "mod": [1, 1, 1]
        },
        "+#% to Quality": {"affects": ["quality"], "type": "f", "mod": [1]},
        "+#% to Fire Resistance": {
            "affects": ["elemental_resists", "total_resists", "fire_resist"],
            "type": "f",
            "mod": [1, 1, 1]
        },
        "+#% to Cold Resistance": {
            "affects": ["elemental_resists", "total_resists", "cold_resist"],
            "type": "f",
            "mod": [1, 1, 1]
        },
        "+#% to Lightning Resistance": {
            "affects": ["elemental_resists", "total_resists", "lightning_resist"],
            "type": "f",
            "mod": [1, 1, 1]
        },
        "+#% to Chaos Resistance": {"affects": ["total_resists", "chaos_resist"], "type": "f", "mod": [1, 1]},
        "+#% to Fire and Cold Resistances": {
            "affects": ["elemental_resists", "total_resists", "fire_resist", "cold_resist"],
            "type": "f",
            "mod": [2, 2, 1, 1]
        },
        "+#% to Fire and Lightning Resistances": {
            "affects": ["elemental_resists", "total_resists", "fire_resist", "lightning_resist"],
            "type": "f",
            "mod": [2, 2, 1, 1]
        },
        "+#% to Cold and Lightning Resistances": {
            "affects": ["elemental_resists", "total_resists", "cold_resist", "lightning_resist"],
            "type": "f",
            "mod": [2, 2, 1, 1]
        },
        "+#% to Cold and Chaos Resistances": {
            "affects": ["elemental_resists", "total_resists", "cold_resist", "chaos_resist"],
            "type": "f",
            "mod": [1, 2, 1, 1]
        },
        "+#% to Fire and Chaos Resistances": {
            "affects": ["elemental_resists", "total_resists", "fire_resist", "chaos_resist"],
            "type": "f",
            "mod": [1, 2, 1, 1]
        },
        "+#% to Lightning and Chaos Resistances": {
            "affects": ["elemental_resists", "total_resists", "lightning_resist", "chaos_resist"],
            "type": "f",
            "mod": [1, 2, 1, 1]
        },
        "+#% to all Elemental Resistances": {
            "affects": ["elemental_resists", "total_resists", "fire_resist", "cold_resist", "lightning_resist"],
            "type": "f",
            "mod": [3, 3, 1, 1, 1]
        },
        ...
        "+# to Strength and Dexterity": {
            "affects": ["strength", "dexterity", "attributes"],
            "type": "f",
            "mod": [1, 1, 2]
        },
        "+# to Strength and Intelligence": {
            "affects": ["strength", "intelligence", "attributes"],
            "type": "f",
            "mod": [1, 1, 2]
        },
        "+# to Dexterity and Intelligence": {
            "affects": ["dexterity", "intelligence", "attributes"],
            "type": "f",
            "mod": [1, 1, 2]
        },
        "+# to all Attributes": {
            "affects": ["strength", "dexterity", "intelligence", "attributes"],
            "type": "f",
            "mod": [1, 1, 1, 3]
        },
        ...
        "options": [
            {
                "type": "radio", "id": "bmd", "name": "Mode", "default": "normal", "choices": [
                    {
                        "name": "Normal",
                        "desc": "Will throw an error if something prevents the benchcraft",
                        "value": "normal"
                    },
