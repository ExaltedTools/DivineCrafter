...
var simulator_presets=[
    {"name":"Alt, Aug, Regal","desc":"","data":"","subs":[
        {"name":"2 prefix","rarity":"magic","data":'[{"method":["currency","alteration"],"autopass":false,"filters":[{"type":"and","treshold":1,"conds":[{"id":"","treshold":1,"init":"- Prefix 1 -"},{"id":"","treshold":1,"init":"- Prefix 2 -"}]}],"vfilter":[],"actions":{"win":"step","win_route":"6","fail":"step","fail_route":"2"}},{"method":["check"],"autopass":false,"filters":[{"type":"and","treshold":null,"conds":[{"id":"open_prefix","treshold":1}]}],"vfilter":[],"actions":{"win":"next","win_route":null,"fail":"restart","fail_route":null}},{"method":["currency","augmentation"],"autopass":false,"filters":[{"type":"and","treshold":1,"conds":[{"id":"","treshold":1,"init":"- Prefix 1 -"},{"id":"","treshold":1,"init":"- Prefix 2 -"}]}],"vfilter":[],"actions":{"win":"step","win_route":"6","fail":"step","fail_route":"1"}},{"method":["currency","scour"],"autopass":true,"filters":null,"vfilter":null,"actions":{"win":"next","win_route":null,"fail":"loop","fail_route":null}},{"method":["currency","transmute"],"autopass":true,"filters":null,"vfilter":null,"actions":{"win":"step","win_route":"1","fail":"loop","fail_route":null}},{"method":["currency","regal"],"autopass":false,"filters":[{"type":"and","treshold":null,"conds":[{"id":"","treshold":1,"init":"- Prefix 1 -"},{"id":"","treshold":1,"init":"- Prefix 2 -"}]}],"vfilter":[],"actions":{"win":"next","win_route":null,"fail":"step","fail_route":"4"}}]'},
        {"name":"2 suffix","rarity":"magic","data":'[{"method":["currency","alteration"],"autopass":false,"filters":[{"type":"and","treshold":1,"conds":[{"id":"","treshold":1,"init":"- Suffix 1 -"},{"id":"","treshold":1,"init":"- Suffix 2 -"}]}],"vfilter":[],"actions":{"win":"step","win_route":"6","fail":"step","fail_route":"2"}},{"method":["check"],"autopass":false,"filters":[{"type":"and","treshold":null,"conds":[{"id":"open_suffix","treshold":1}]}],"vfilter":[],"actions":{"win":"next","win_route":null,"fail":"restart","fail_route":null}},{"method":["currency","augmentation"],"autopass":false,"filters":[{"type":"and","treshold":1,"conds":[{"id":"","treshold":1,"init":"- Suffix 1 -"},{"id":"","treshold":1,"init":"- Suffix 2 -"}]}],"vfilter":[],"actions":{"win":"step","win_route":"6","fail":"step","fail_route":"1"}},{"method":["currency","scour"],"autopass":true,"filters":null,"vfilter":null,"actions":{"win":"next","win_route":null,"fail":"loop","fail_route":null}},{"method":["currency","transmute"],"autopass":true,"filters":null,"vfilter":null,"actions":{"win":"step","win_route":"1","fail":"loop","fail_route":null}},{"method":["currency","regal"],"autopass":false,"filters":[{"type":"and","treshold":null,"conds":[{"id":"","treshold":1,"init":"- Suffix 1 -"},{"id":"","treshold":1,"init":"- Suffix 2 -"}]}],"vfilter":[],"actions":{"win":"next","win_route":null,"fail":"step","fail_route":"4"}}]'},
        {"name":"2 prefix, 1 suffix","rarity":"magic","data":'[{"method":["currency","alteration"],"autopass":false,"filters":[{"type":"and","treshold":2,"conds":[{"id":"","treshold":1,"init":"- Prefix 1 -"},{"id":"","treshold":1,"init":"- Prefix 2 -"},{"id":"","treshold":1,"init":"- Suffix 1 -"}]}],"vfilter":[],"actions":{"win":"step","win_route":"7","fail":"step","fail_route":"2"}},{"method":["check"],"autopass":false,"filters":[{"type":"and","treshold":1,"conds":[{"id":"","treshold":1,"init":"- Prefix 1 -"},{"id":"","treshold":1,"init":"- Prefix 2 -"},{"id":"","treshold":1,"init":"- Suffix 1 -"}]}],"vfilter":[],"actions":{"win":"next","win_route":null,"fail":"restart","fail_route":null}},{"method":["check"],"autopass":false,"filters":[{"type":"and","treshold":1,"conds":[{"id":"open_prefix","treshold":1},{"id":"open_suffix","treshold":1}]}],"vfilter":[],"actions":{"win":"next","win_route":null,"fail":"restart","fail_route":null}},{"method":["currency","augmentation"],"autopass":false,"filters":[{"type":"and","treshold":2,"conds":[{"id":"","treshold":1,"init":"- Prefix 1 -"},{"id":"","treshold":1,"init":"- Prefix 2 -"},{"id":"","treshold":1,"init":"- Suffix 1 -"}]}],"vfilter":[],"actions":{"win":"step","win_route":"7","fail":"step","fail_route":"1"}},{"method":["currency","scour"],"autopass":true,"filters":null,"vfilter":null,"actions":{"win":"next","win_route":null,"fail":"loop","fail_route":null}},{"method":["currency","transmute"],"autopass":true,"filters":null,"vfilter":null,"actions":{"win":"step","win_route":"1","fail":"loop","fail_route":null}},{"method":["currency","regal"],"autopass":false,"filters":[{"type":"and","treshold":null,"conds":[{"id":"","treshold":1,"init":"- Prefix 1 -"},{"id":"","treshold":1,"init":"- Prefix 2 -"},{"id":"","treshold":1,"init":"- Suffix 1 -"}]}],"vfilter":[],"actions":{"win":"next","win_route":null,"fail":"step","fail_route":"5"}}]'},
        {"name":"2 suffix, 1 prefix","rarity":"magic","data":'[{"method":["currency","alteration"],"autopass":false,"filters":[{"type":"and","treshold":2,"conds":[{"id":"","treshold":1,"init":"- Suffix 1 -"},{"id":"","treshold":1,"init":"- Prefix 2 -"},{"id":"","treshold":1,"init":"- Prefix 1 -"}]}],"vfilter":[],"actions":{"win":"step","win_route":"7","fail":"step","fail_route":"2"}},{"method":["check"],"autopass":false,"filters":[{"type":"and","treshold":1,"conds":[{"id":"","treshold":1,"init":"- Suffix 1 -"},{"id":"","treshold":1,"init":"- Suffix 2 -"},{"id":"","treshold":1,"init":"- Prefix 1 -"}]}],"vfilter":[],"actions":{"win":"next","win_route":null,"fail":"restart","fail_route":null}},{"method":["check"],"autopass":false,"filters":[{"type":"and","treshold":1,"conds":[{"id":"open_prefix","treshold":1},{"id":"open_suffix","treshold":1}]}],"vfilter":[],"actions":{"win":"next","win_route":null,"fail":"restart","fail_route":null}},{"method":["currency","augmentation"],"autopass":false,"filters":[{"type":"and","treshold":2,"conds":[{"id":"","treshold":1,"init":"- Suffix 1 -"},{"id":"","treshold":1,"init":"- Suffix 2 -"},{"id":"","treshold":1,"init":"- Prefix 1 -"}]}],"vfilter":[],"actions":{"win":"step","win_route":"7","fail":"step","fail_route":"1"}},{"method":["currency","scour"],"autopass":true,"filters":null,"vfilter":null,"actions":{"win":"next","win_route":null,"fail":"loop","fail_route":null}},{"method":["currency","transmute"],"autopass":true,"filters":null,"vfilter":null,"actions":{"win":"step","win_route":"1","fail":"loop","fail_route":null}},{"method":["currency","regal"],"autopass":false,"filters":[{"type":"and","treshold":null,"conds":[{"id":"","treshold":1,"init":"- Suffix 1 -"},{"id":"","treshold":1,"init":"- Suffix 2 -"},{"id":"","treshold":1,"init":"- Prefix 1 -"}]}],"vfilter":[],"actions":{"win":"next","win_route":null,"fail":"step","fail_route":"5"}}]'}
    ]},
    {"name":"Alt, Aug, Imprint, Regal","desc":"","data":"","subs":[
        {"name":"Required prefix","rarity":"magic","data":'[{"method":["currency","alteration"],"autopass":false,"filters":[{"type":"and","treshold":null,"conds":[{"id":"","treshold":1,"init":"- Required Prefix -"}]}],"vfilter":[],"actions":{"win":"step","win_route":"4","fail":"step","fail_route":"2"}},{"method":["check"],"autopass":false,"filters":[{"type":"and","treshold":null,"conds":[{"id":"open_prefix","treshold":1}]}],"vfilter":[],"actions":{"win":"next","win_route":null,"fail":"step","fail_route":"1"}},{"method":["currency","augmentation"],"autopass":false,"filters":[{"type":"and","treshold":null,"conds":[{"id":"","treshold":1,"init":"- Required Prefix -"}]}],"vfilter":[],"actions":{"win":"next","win_route":null,"fail":"step","fail_route":"1"}},{"method":["beast_crafting","imprint"],"autopass":true,"filters":null,"vfilter":null,"actions":{"win":"step","win_route":"6","fail":"loop","fail_route":null}},{"method":["beast_crafting","restimprint"],"autopass":true,"filters":null,"vfilter":null,"actions":{"win":"step","win_route":"4","fail":"loop","fail_route":null}},{"method":["currency","regal"],"autopass":false,"filters":[{"type":"and","treshold":null,"conds":[{"id":"","treshold":1,"init":"- Second Affix -"}]}],"vfilter":[],"actions":{"win":"next","win_route":null,"fail":"step","fail_route":"5"}}]'},
        {"name":"Required suffix","rarity":"magic","data":'[{"method":["currency","alteration"],"autopass":false,"filters":[{"type":"and","treshold":null,"conds":[{"id":"","treshold":1,"init":"- Required Suffix -"}]}],"vfilter":[],"actions":{"win":"step","win_route":"4","fail":"step","fail_route":"2"}},{"method":["check"],"autopass":false,"filters":[{"type":"and","treshold":null,"conds":[{"id":"open_suffix","treshold":1}]}],"vfilter":[],"actions":{"win":"next","win_route":null,"fail":"step","fail_route":"1"}},{"method":["currency","augmentation"],"autopass":false,"filters":[{"type":"and","treshold":null,"conds":[{"id":"","treshold":1,"init":"- Required Suffix -"}]}],"vfilter":[],"actions":{"win":"next","win_route":null,"fail":"step","fail_route":"1"}},{"method":["beast_crafting","imprint"],"autopass":true,"filters":null,"vfilter":null,"actions":{"win":"step","win_route":"6","fail":"loop","fail_route":null}},{"method":["beast_crafting","restimprint"],"autopass":true,"filters":null,"vfilter":null,"actions":{"win":"step","win_route":"4","fail":"loop","fail_route":null}},{"method":["currency","regal"],"autopass":false,"filters":[{"type":"and","treshold":null,"conds":[{"id":"","treshold":1,"init":"- Second Affix -"}]}],"vfilter":[],"actions":{"win":"next","win_route":null,"fail":"step","fail_route":"5"}}]'}
    ]},
    {"name":"Woke Prefixes, Reforge","desc":"Awaken 2 Prefixes together then harvest reforge for 3rd","data":'[{"method":["currency","woke"],"autopass":false,"filters":[{"type":"and","treshold":null,"conds":[{"id":"","treshold":1,"init":"- 3rd target prefix -"}]}],"vfilter":[],"actions":{"win":"end","win_route":null,"fail":"step","fail_route":"2"}},{"method":["check"],"autopass":false,"filters":[{"type":"and","treshold":null,"conds":[{"id":"open_prefix","treshold":1},{"id":"open_suffix","treshold":1}]}],"vfilter":[],"actions":{"win":"step","win_route":"4","fail":"step","fail_route":"3"}},{"method":["currency","annul"],"autopass":false,"filters":[{"type":"and","treshold":null,"conds":[{"id":"","treshold":1,"init":"- Awakened prefix 1 -"},{"id":"","treshold":1,"init":"- Awakened prefix 2 -"}]}],"vfilter":[],"actions":{"win":"step","win_route":"2","fail":"restart","fail_route":null}},{"method":["bench","|2962t0|"],"autopass":true,"filters":null,"vfilter":null,"actions":{"win":"next","win_route":null,"fail":"restart","fail_route":null}},{"method":["harvest","hreroll"],"autopass":true,"filters":null,"vfilter":null,"actions":{"win":"next","win_route":null,"fail":"loop","fail_route":null}}]'},
    {"name":"Woke Suffixes, Reforge","desc":"Awaken 2 Suffixes together then harvest reforge for 3rd","data":'[{"method":["currency","woke"],"autopass":false,"filters":[{"type":"and","treshold":null,"conds":[{"id":"","treshold":1,"init":"- 3rd target suffix -"}]}],"vfilter":[],"actions":{"win":"end","win_route":null,"fail":"step","fail_route":"2"}},{"method":["check"],"autopass":false,"filters":[{"type":"and","treshold":null,"conds":[{"id":"open_prefix","treshold":1},{"id":"open_suffix","treshold":1}]}],"vfilter":[],"actions":{"win":"step","win_route":"4","fail":"step","fail_route":"3"}},{"method":["currency","annul"],"autopass":false,"filters":[{"type":"and","treshold":null,"conds":[{"id":"","treshold":1,"init":"- Awakened suffix 1 -"},{"id":"","treshold":1,"init":"- Awakened suffix 2 -"}]}],"vfilter":[],"actions":{"win":"step","win_route":"2","fail":"restart","fail_route":null}},{"method":["bench","|2963t0|"],"autopass":true,"filters":null,"vfilter":null,"actions":{"win":"next","win_route":null,"fail":"restart","fail_route":null}},{"method":["harvest","hreroll"],"autopass":true,"filters":null,"vfilter":null,"actions":{"win":"next","win_route":null,"fail":"loop","fail_route":null}}]'}
];

var simulator_metam=[
    {"name":"Wipe prefixes","autopass":true,"seq":[
        {"method":["check"],"autopass":false,"actions":{"win":"next","win_route":null,"fail":"step","fail_route":4},"filters":[
            {"type":"or","treshold":null,"conds":[{"id":"open_prefix","treshold":1,"max":null}]}
        ]},
        {"method":["bench","|2963t0|"],"autopass":true,"actions":{"win":"next","win_route":null,"fail":null,"fail_route":null},"filters":[]},
        {"method":["currency","scour"],"autopass":true,"actions":{"win":"end","win_route":null,"fail":null,"fail_route":null},"filters":[]},
        {"method":["harvest","hother","hrepf"],"autopass":false,"actions":{"win":"step","win_route":2,"fail":"loop","fail_route":null},"filters":[
            {"type":"or","treshold":null,"conds":[{"id":"open_prefix","treshold":1,"max":null}]}
        ]}
    ]},
    {"name":"Wipe suffixes","autopass":true,"seq":[
        ...
        {"method":["bench","|2962t0|"],"autopass":true,"actions":{"win":"next","win_route":null,"fail":null,"fail_route":null},"filters":[]},
        {"method":["currency","scour"],"autopass":true,"actions":{"win":"end","win_route":null,"fail":null,"fail_route":null},"filters":[]},
        {"method":["harvest","hother","hresf"],"autopass":false,"actions":{"win":"step","win_route":2,"fail":"loop","fail_route":null},"filters":[
            {"type":"or","treshold":null,"conds":[{"id":"open_suffix","treshold":1,"max":null}]}
        ]}
    ]},
    {"name":"Annul save prefix","autopass":false,"seq":[
        {"method":["bench","|2963t0|"],"autopass":true,"actions":{"win":"next","win_route":null,"fail":null,"fail_route":null},"filters":[]},
        {"method":["currency","annul"],"autopass":false,"actions":{"win":"next","win_route":null,"fail":"restart","fail_route":null},"filters":[
            {"type":"or","treshold":null,"conds":[{"id":"[COND:1]","treshold":null,"max":null}]}
        ]},
        {"method":["check"],"autopass":false,"actions":{"win":"end","win_route":null,"fail":"step","fail_route":1},"filters":[
...
function poec_initSimulator(timeout){
    if($("#poecSimulator").length==0){
        ...
        if(timeout){
            setTimeout(function(){poec_simInitLoad();},1);
        }else{
            poec_simInitLoad();
        }
...
function poec_nsimRestart(delta,init){
    if(init){
      $("#nsimRestartBtn").mcuiNotice({text:applyLang("You will lose current project<br/>are you sure you wish to proceed?"),type:"confirm",complete:function(delta){poec_nsimRestart(delta,false);}}).showNotice();
    }else{
      if(delta==true){
...
function poec_nsimGoToStep(step){
    ...
    switch(step){
      ...
      case 5 :
        ...
        if(simulator_settings["ilvl"]==null){simulator_settings["ilvl"]=100;}
        ...
        if(simulator_settings["quality"]==undefined){simulator_settings["quality"]=20;}
...
function poec_nsimBuildIntBase(simulator_crsets,imported){
    ...
    switch(parseInt(simulator_settings["bitem"])){
        case 8209 : simulator_data["maxaffgrp"]={"prefix":2,"suffix":4}; break; // Cogwork
        case 8224 : simulator_data["maxaffgrp"]={"prefix":4,"suffix":2}; break; // Geodesic
        case 8246 : simulator_data["maxaffgrp"]={"prefix":2,"suffix":2}; break; // Simplex
        case 8201 : simulator_settings["influences"]=[2,3,4,5,6,7]; break; // Astrolabe
    }

    switch(simulator_settings["rarity"]){
        case 'normal' : simulator_data["cmaxaffgrp"]={"prefix":0,"suffix":0}; break;
        case 'magic' : simulator_data["cmaxaffgrp"]={"prefix":1,"suffix":1}; break;
        default : simulator_data["cmaxaffgrp"]=simulator_data["maxaffgrp"]; break;
    }
    ...
    if(usewhat=="emu"){
        ...
        if(poec_cImps){
            if(Object.keys(poec_cImps).length>0){
                $.each(poec_cImps,function(modid,tilvl){
                    ...
                    if(tilvl!=null){
                        if(!simulator_crsets["eldritch"]){simulator_crsets["eldritch"]={};}
        ...
        if(poec_cMethod){
            switch(poec_cMethod){
                ...
                break;
                case 'chaos' : simuusemethod=['currency','chaos']; break;
                case 'exalted' : simuusemethod=['currency','exalted']; break;
                case 'alchemy' : simuusemethod=['currency','alchemy']; break;
                case 'alteration' : simuusemethod=['currency','alteration']; 
                    if(poec_cAdvMet){
                        // poec_cMandatory
                        switch(poec_cAdvMet){
                            case 'aa' : 
                ...
                break;
                case 'augmentation' : simuusemethod=['currency','augmentation']; break;
                case 'transmute' : simuusemethod=['currency','transmute']; break;
                case 'regal' : simuusemethod=['currency','regal']; break;
                case 'crusader' : simuusemethod=['currency','crusader']; break;
                case 'redeemer' : simuusemethod=['currency','redeemer']; break;
                case 'hunter' : simuusemethod=['currency','hunter']; break;
                case 'warlord' : simuusemethod=['currency','warlord']; break;
            }
        }
    }
                ...
                switch(mcustom){
                    case 'harvest_basic' : 
                        for(var i=0;i<poecd['mtypes']['seq'].length;i++){
                            if(poecd['mtypes']['seq'][i]["harvest"]=="1"){
                                cindex[poecd['mtypes']['seq'][i]["id_mtype"]]={"name":poecl["mtype"][poecd['mtypes']['seq'][i]["id_mtype"]],"img":null};
                    ...
                    case 'essences' : 
                        if(simulator_essences){
                            for(var i=0;i<simulator_essences.length;i++){
                                cindex[simulator_essences[i]["essid"]]={"name":simulator_essences[i]["essname"]+" : "+simulator_essences[i]["mname"],"img":simulator_essences[i]["essimg"]};
                        ...
                        for(var i=0;i<simulator_essences.length;i++){
                            if("ess"+simulator_essences[i]["essid"]==mkey){
                                for(var j=0;j<simulator_essences[i]["tiers"].length;j++){
                                    ...
                                    cindex[simulator_essences[i]["tiers"][j]["tindex"]]={"name":"T"+tn+" : "+simulator_essences[i]["tiers"][j]["tname"],"img":null};
                    ...
                    case 'catalysts' : 
                        for(var i=0;i<poecd['catalysts']['seq'].length;i++){
                            cindex[poecd['catalysts']['seq'][i]["id_catalyst"]]={"name":poecl["catalyst"][poecd['catalysts']['seq'][i]["id_catalyst"]],"img":"catalyst_"+poecd['catalysts']['seq'][i]["id_catalyst"]};
                    ...
                    case 'fossils' :
                        for(var i=0;i<poecd['fossils']['seq'].length;i++){
                            if(poec_constants["constraints"]["ignore_fossils"].indexOf("|"+poecd['fossils']['seq'][i]["id_fossil"]+"|")>-1){}else{
                                var tpass=true;
                                switch(poecd['fossils']['seq'][i]["id_fossil"]){
                                    case "18" : 
                                        if(poec_constants["constraints"]["hollow_bgroups"].indexOf("|"+simulator_settings["bgroup"]+"|")>-1){}else{
                                            tpass=false;
                                        }
                                    break;
                                }
                                if(tpass){
                                    cindex[poecd['fossils']['seq'][i]["id_fossil"]]={"name":poecl["fossil"][poecd['fossils']['seq'][i]["id_fossil"]],"img":"fossil_"+poecd['fossils']['seq'][i]["id_fossil"]};
...
function poec_nsimGenStartingItem(){
    ...
    // Behavior
    $("<div>").addClass("item_opts").click(function(){poec_nsimItemSwapOptions($(this),"start");}).appendTo($("#poecSimItem").find(".poec_item"));
}
...
function poec_nsimBuildOptionsInterface(){
    ...
    $("#poecSimOptions").find(".mcui-radio").mcuiRadio({"change":function(val,elem){poec_simSetOptions(false,val,elem);}});
    $("#poecSimOptions").find(".mcui-checkbox").mcuiCheck({"change":function(val,elem){poec_simSetOptions(false,val,elem);}});
    /* SEQUENCE CONFIG */
    ...
    $("#poecSimFlowSplitConf").keyup(function(){
        if($("#poecSimFlowSplit").mcuiCheck().getVal()){
            ...
            nsim_splitconftm=setTimeout(function(){poec_simInitFlowchartGO();},500);
        }
    });
...
function poec_simChangeMainTab(val){
    ...
    switch(val){
        case 'instructions' : poec_simGenerateInstruction("standard"); break;
        case 'save' : poec_simInitSaveTab(); break;
        case 'results' : $("#poecSimDebugItem").show(); break;
        case 'flow' : 
...
function poec_nsimAddSeqStep(init,addwhere,snum){
    ...
    if(cont){
        ...
        // Behaviors
        $("#poecSimCondAutoPass"+nstep).mcuiCheck({change:function(val,elem){poec_nsimToggleAutoPass(val,elem);}});
        $("#poecSimSuccessMode"+nstep).mcuiRadio({change:function(val,elem){poec_nsimToggleStepSelector(val,elem);}});
        $("#poecSimFailMode"+nstep).mcuiRadio({change:function(val,elem){poec_nsimToggleStepSelector(val,elem);}});
...
function poec_simChangeStepOrder(stepord,reversed){
    ...
    $.each(arrg,function(key,elem){
        ...
        if(stepord[nstep]!=nstep){ // ordering changed for this one
            ...
            $("#poecSimCondAutoPass"+nstep).attr({"id":"poecSimCondAutoPass"+stepord[nstep],"step":stepord[nstep]});
            $("#poecSimSuccessMode"+nstep).attr({"id":"poecSimSuccessMode"+stepord[nstep]});
            $("#poecSimSuccessStep"+nstep).attr({"id":"poecSimSuccessStep"+stepord[nstep],"sindex":"step"+stepord[nstep],"skey":"step"+stepord[nstep]});
            $("#poecSimFailMode"+nstep).attr({"id":"poecSimFailMode"+stepord[nstep]});
            $("#poecSimFailureStep"+nstep).attr({"id":"poecSimFailureStep"+stepord[nstep],"sindex":"step"+stepord[nstep],"skey":"step"+stepord[nstep]});
            $("#poecSimCopyStepSel"+nstep).attr({"id":"poecSimCopyStepSel"+stepord[nstep],"sindex":"cstep"+stepord[nstep],"skey":"cstep"+stepord[nstep]});
            ...
            $("#poecSimCondAddGroup"+nstep).attr({"id":"poecSimCondAddGroup"+stepord[nstep],"nstep":stepord[nstep],"sindex":"fgroupadd"+stepord[nstep],"skey":"fgroupadd"+stepord[nstep]});
...
function poec_nsimUpdateStepSelectors(){
    ...
    $("#poecSimSeqZone").find(".step").each(function(){
        if($(this).find(".success_opt").is(":visible")){
            ...
            for(var i=1;i<=nsteps;i++){
                if(i!=nstep&&i!=nstep+1){
                    if(stepvars[nstep-1]["success"]==i){cvfound=true;}
                    sHTML+="<div class='opt mkey_"+i+"' mkey='"+i+"' mparent='null'>"+stepterm+" "+i+"</div>";
                }
            }
            if(sHTML!=""){
                ...
                if(!cvfound){$("#poecSimSuccessStep"+nstep).attr("curval","null");}
        ...
        if($(this).find(".failure_opt").is(":visible")){
            ...
            for(var i=1;i<=nsteps;i++){
                if(i!=nstep){
                    if(stepvars[nstep-1]["failure"]==i){cvfound=true;}
                    sHTML+="<div class='opt mkey_"+i+"' mkey='"+i+"' mparent='null'>"+stepterm+" "+i+"</div>";
                }
            }
            if(sHTML!=""){
                ...
                if(!cvfound){$("#poecSimFailureStep"+nstep).attr("curval","null");}
                poec_nsimInitSelector($("#poecSimFailureStep"+nstep));
            }else{
...
function poec_nsimSetFilter(selnode){
    ...
    if(cval=="null"){
        ...
        if(isNaN(elevated)){elevated=0;}
        if(elevated==1){var minval=0;}else{var minval=1;}
            ...
            if(poec_cmethods[skey]["options"]!=undefined){
                for(var i=0;i<poec_cmethods[skey]["options"].length;i++){
                    ...
                    switch(poec_cmethods[skey]["options"][i]["type"]){
                        case 'check' : 
                            if(poec_cmethods[skey]["options"][i]["default"]){var checked="ischecked";}else{var checked="unchecked";}
                        ...
                        case 'radio' : 
                            ...
                            for(var j=0;j<poec_cmethods[skey]["options"][i]["choices"].length;j++){
                                ...
                                if(poec_cmethods[skey]["options"][i]["default"]==poec_cmethods[skey]["options"][i]["choices"][j]["value"]){var sel=" selected";}else{var sel="";}
    ...
    if(dat["required"]!=undefined){
        $.each(dat["required"],function(key,val){
            switch(key){
                ...
                break;
                case "bgroup" : 
                    if(val.indexOf("|"+simulator_settings["bgroup"]+"|")>-1){}else{
                        pass=false;
                    }
                break;
            }
...
function poec_nsimImportGo(data,init){
    ...
    if(data||!init){
        try{
            ...
            if(import_data["params"]){
                ...
                $("#nsimImportBtn").mcuiNotice({text:applyLang("This appears to be an emulator dataset!"),type:"alert"}).showNotice();
    ...
    if(import_success){
        ...
        setTimeout(function(){poec_nsimImportGoFinal(import_data);},1);
    }
}
        ...
        if(config[i]["mopts"]){
            $.each(config[i]["mopts"],function(okey,oval){
                $("#poecSimSeqStep"+nstep).find(".method").find(".nopt_"+okey).each(function(){
                    ...
                    switch(opttype){
                        case 'check' : $(this).mcuiCheck().setState(oval); break;
                        case 'radio' : $(this).mcuiRadio().setVal(oval); break;
                    }
                });
            });
        }
    ...
    $("#poecSimSequence").find(".step").each(function(){
        ...
        $(this).find(".method").find(".nsimsel:not(.tangled)").each(function(){
            ...
            if(typeof curval=="String"){
                if(curval.indexOf("|tangled|")>-1){
                    method.push({"pos":$(this).parent().find(".tangled.pos").attr("curval"),"neg":$(this).parent().find(".tangled.neg").attr("curval")});
                }
            }
        });
        step["method"]=method;
        ...
        if($(this).find(".method").find(".nopt").length>0){
            ...
            $(this).find(".method").find(".nopt").each(function(){
                ...
                switch(opttype){
                    case 'check' : options[optid]=$(this).mcuiCheck().getVal(); break;
                    case 'radio' : options[optid]=$(this).mcuiRadio().getVal(); break;
                }
            });
        }
        step["mopts"]=options;
                ...
                $(this).find(".nsimfilter").each(function(){
                    ...
                    if(curval){
                        ...
                        if(curval.indexOf("pseudo_")>-1){
                            ...
                            if(nsim_activepseudos==null){nsim_activepseudos={};}
...
function poec_simStartSimulation(){
    ...
    $("#poecSimSequence").find(".method").find(".nsimsel").each(function(){
        ...
        if(curval=="null"){
            ...
            if(curval.indexOf("|tangled|")>-1){
                ...
                if(pos=="null"){
                    errors={"type":"method","node":$(this).parent().find(".tangled.pos"),"step":$(this).parent().parent().parent().attr("nstep")};
                    return false;
                }else{
                    var neg=$(this).parent().find(".tangled.neg").attr("curval");
                    if(neg=="null"){
                        errors={"type":"method","node":$(this).parent().find(".tangled.neg"),"step":$(this).parent().parent().parent().attr("nstep")};
                        return false;
                    }
                }
            }
            ...
            if(autopass==0){
                ...
                if(fmcv=="modunveil"){
                    ...
                    if(totvalid==0&&!errors){
                        errors={"type":"condition","node":$("#poecSimCondArea1").find(".condition_zone:eq(0)").find('.nsimfilter:first'),"step":1,"zone":1};
                    }
                }
            }
            if(errors){
                ...
                if($("#poecSimSuccessStep"+nstep).is(":visible")){
                    ...
                    if(cval=="step"){
                        if($("#poecSimSuccessStep"+nstep).attr("curval")=="null"){
                            errors={"type":"step","node":$("#poecSimSuccessStep"+nstep),"step":nstep,"stype":"success"};
                            return false;
                        }
                    }
                }
                ...
                if($("#poecSimFailureStep"+nstep).is(":visible")){
                    ...
                    if(cval=="step"){
                        if($("#poecSimFailureStep"+nstep).attr("curval")=="null"){
                            errors={"type":"step","node":$("#poecSimFailureStep"+nstep),"step":nstep,"stype":"failure"};
                            return false;
                        }
                    }
                }
    ...
    if(errors){
        ...
        switch(errors["type"]){
            case 'method' : errmsg+=applyLang("Missing method for step")+" "+errors["step"]; break;
            case 'condition' : errmsg+=applyLang("No condition set for step")+" "+errors["step"]+" "+applyLang("zone")+" "+errors["zone"]; break;
            case 'treshold' : errmsg+=applyLang("No min/max set for condition on step")+" "+errors["step"]+" "+applyLang("zone")+" "+errors["zone"]; break;
            case 'vcondition' : errmsg+=applyLang("No condition set for step")+" "+errors["step"]; break;
            case 'step' : errmsg+=applyLang("Go to step selection missing for step")+" "+errors["step"]+" "+applyLang(errors["stype"]); break;
        }
        errmsg+="</div>";
                            ...
                            if(usemm["seq"][k]["actions"]["fail"]=="step"){
                                ...
                                if(usemm["seq"][k]["actions"]["fail"]=="restart"){ // Go to true fail route
                                    switch(execution_config[j]["actions"]["fail"]){
                                        case 'loop' : break; // Should not be a logical or possible choice?
                                        case 'step' : 
                                        ...
                                        break;
                                        case 'restart' : break; // Leave restart
                                    }
                                }
                            }
...
function poec_simLoopAction(){
    ...
    if(simState==true){
        if(nsimMode=="fx"){
            ...
            if(nsimMode=="rt"){
                poec_simLoopRTUpd();
                setTimeout(function(){poec_simLoopAction();},1);
            }else{
...
function poec_simApplyBenchCraft(){
    ...
    if(bench[0]["id"]!="remove_bench"){
        var openaff={"prefix":crsim_bypass["cmaxaffgrp"]["prefix"]-crsim_bypass["iaffbt"]["prefix"],"suffix":crsim_bypass["cmaxaffgrp"]["suffix"]-crsim_bypass["iaffbt"]["suffix"]};
    ...
    if(errtype){
        switch(errtype){
            case 'prefix' :case 'suffix' : errtype=applyLang("No "+errtype+" left to add benchcraft on step ")+(nsim_cstep+1); break;
            case 'id' : errtype=applyLang("Benchcraft already there on step ")+(nsim_cstep+1); break;
            case 'modgroup' : errtype=applyLang("Modgroup conflict for benchcraft on step ")+(nsim_cstep+1); break;
        }
        var skiperror=false;
    ...
    if(crsim_bypass["corrupted"]==1){
        ...
        if(verif){
            ...
            switch(nsim_econfig[nsim_cstep]["method"][0]){
                case 'check' : break; // Do nothing and proceed to conditions
                case 'bench' : poec_simApplyBenchCraft(); break;
                case 'modunveil' : if(crsim_bypass["vpicks"]==null){ poec_simUnveilModifier(); } break;
                case 'recombinate' : 
            ...
            if(simState){
                            ...
                            for(var j=0;j<nsim_econfig[nsim_cstep]["filters"][i]["conds"].length;j++){ // Condition
                                ...
                                if(affdat[modid]!=undefined){
                                    ...
                                    if(nsim_econfig[nsim_cstep]["filters"][i]["conds"][j]["type"]!="normal"){
                                        switch(modid){
                                            case 'open_prefix' : if(poec_checkAgainstRange(crsim_bypass["cmaxaffgrp"]["prefix"]-crsim_bypass["iaffbt"]["prefix"],nsim_econfig[nsim_cstep]["filters"][i]["conds"][j])){npass++;}break;
                                            case 'open_suffix' : if(poec_checkAgainstRange(crsim_bypass["cmaxaffgrp"]["suffix"]-crsim_bypass["iaffbt"]["suffix"],nsim_econfig[nsim_cstep]["filters"][i]["conds"][j])){npass++;}break;
                                            case 'open_affix' : if(poec_checkAgainstRange((crsim_bypass["cmaxaffgrp"]["suffix"]+crsim_bypass["cmaxaffgrp"]["prefix"])-(crsim_bypass["iaffbt"]["suffix"]+crsim_bypass["iaffbt"]["prefix"]),nsim_econfig[nsim_cstep]["filters"][i]["conds"][j])){npass++;}break;
                                            case 'count_prefix' : if(poec_checkAgainstRange(crsim_bypass["iaffbt"]["prefix"],nsim_econfig[nsim_cstep]["filters"][i]["conds"][j])){npass++;}break;
                                            case 'count_suffix' : if(poec_checkAgainstRange(crsim_bypass["iaffbt"]["suffix"],nsim_econfig[nsim_cstep]["filters"][i]["conds"][j])){npass++;}break;
                                            case 'count_affix' : if(poec_checkAgainstRange((crsim_bypass["iaffbt"]["suffix"]+crsim_bypass["iaffbt"]["prefix"]),nsim_econfig[nsim_cstep]["filters"][i]["conds"][j])){npass++;}break;
                                            case 'count_iprefix' : if(poec_checkAgainstRange(ninfs["prefix"],nsim_econfig[nsim_cstep]["filters"][i]["conds"][j])){npass++;}break;
                                            case 'count_isuffix' : if(poec_checkAgainstRange(ninfs["suffix"],nsim_econfig[nsim_cstep]["filters"][i]["conds"][j])){npass++;}break;
                                            case 'count_iaffix' : if(poec_checkAgainstRange((ninfs["prefix"]+ninfs["suffix"]),nsim_econfig[nsim_cstep]["filters"][i]["conds"][j])){npass++;}break;
                                            case 'veiled_prefix' : if(poec_checkAgainstRange(nveiled["prefix"],nsim_econfig[nsim_cstep]["filters"][i]["conds"][j])){npass++;}break;
                                            case 'veiled_suffix' : if(poec_checkAgainstRange(nveiled["suffix"],nsim_econfig[nsim_cstep]["filters"][i]["conds"][j])){npass++;}break;
                                            case 'quality' : 
                                                ...
                                                if(poec_checkAgainstRange(checkqual,nsim_econfig[nsim_cstep]["filters"][i]["conds"][j])){npass++;}
                                            break;
                                            case 'eldritch_blue' : 
                                                if(crsim_bypass["eldritch"]){
                                            ...
                                            break;
                                            case 'count_attack' : if(poec_checkAgainstRange(nmetas["attack"],nsim_econfig[nsim_cstep]["filters"][i]["conds"][j])){npass++;}break;
                                            case 'count_nattack' : if(poec_checkAgainstRange((crsim_bypass["iaffbt"]["suffix"]+crsim_bypass["iaffbt"]["prefix"])-nmetas["attack"],nsim_econfig[nsim_cstep]["filters"][i]["conds"][j])){npass++;}break;
                                            case 'count_caster' : if(poec_checkAgainstRange(nmetas["caster"],nsim_econfig[nsim_cstep]["filters"][i]["conds"][j])){npass++;}break;
                                            case 'count_ncaster' : if(poec_checkAgainstRange((crsim_bypass["iaffbt"]["suffix"]+crsim_bypass["iaffbt"]["prefix"])-nmetas["caster"],nsim_econfig[nsim_cstep]["filters"][i]["conds"][j])){npass++;}break;
                                            default:
                                                // PSEUDOS
                ...
                if(pass){
                    ...
                    switch(nsim_econfig[nsim_cstep]["actions"]["win"]){
                        case 'next' : nsim_cstep++; break;
                        case 'end' : nsim_cstep=nsim_nstep; break;
                        case 'step' : nsim_cstep=nsim_econfig[nsim_cstep]["actions"]["win_route"]-1; break;
                    }
                }else{
                    // Route fail
                    switch(nsim_econfig[nsim_cstep]["actions"]["fail"]){
                        case 'loop' : break; // Doing the same thing again, do nothing
                        case 'restart' : nsim_cstep=0; 
                        crsim_bypass=jQuery.parseJSON(JSON.stringify(nsim_sdata));
                        break;
                        case 'step' : nsim_cstep=nsim_econfig[nsim_cstep]["actions"]["fail_route"]-1; break;
                    }
                }
...
function poec_simActionSucceed(){
    if(nsimStoreItems){
        if(nsim_items.length<nsim_maxitems){
            if(crsim_bypass["catalyst"]==undefined){crsim_bypass["catalyst"]=null;}
            nsim_items.push({
...
function poec_simOutputRItems(){
    ...
    // Behavior
    $("<div>").addClass("item_opts").click(function(){poec_nsimItemSwapOptions($(this),"result");}).appendTo($("#poecSimItemsZone").find(".poec_item"));
    $("<div>").addClass("abtn nsimclipbtn").click(function(){poec_nsimCopyToClipboard($(this));}).html('<img src="images/manual/clip.png">').appendTo($("#poecSimItemsZone").find(".poec_item"));
...
function poec_nsimItemSwapOptions(vThis,type){
    ...
    $("#poecSAffContext").css({"right":$(window).width()-($(vThis).offset().left+$(vThis).width()),"top":$(vThis).offset().top-1}).html(vHTML).show();
}
                        ...
                        switch(nsim_econfig[i]["method"][0]){
                            case 'fossil' : 
                                ...
                                for(var l=0;l<nsim_econfig[i]["method"][j].length;l++){
                                    ...
                                    mcur.push({"name":"<img src='images/manual/fossil_6.png'/>"+mroot["name"]+"<div class='sep'>></div><img src='images/manual/"+poecsim_selectors[nsim_econfig[i]["method"][j-1]]["cindex"][nsim_econfig[i]["method"][j][l]]["img"]+".png'/> "+poecsim_selectors[nsim_econfig[i]["method"][j-1]]["cindex"][nsim_econfig[i]["method"][j][l]]["name"],"id":"fossil_"+nsim_econfig[i]["method"][j][l],"num":1});
                                }
                                mcur.push({"name":"<img src='images/manual/fossil_6.png'/>"+mroot["name"]+"<div class='sep'>></div><img src='images/manual/resonator_"+nsim_econfig[i]["method"][j].length+".png'/>"+nsim_econfig[i]["method"][j].length+"-Socket Resonator","id":"reso_"+nsim_econfig[i]["method"][j].length,"num":1});
                                mroot={
                                    "name":name,
                                    "img":img
                                }
                                        ...
                                        if(poecc["benchcosts"][bckey]!=undefined){
                                            if(poecc["benchcosts"][bckey][nsim_econfig[i]["method"][j][l]["tier"]]!=undefined){
                                                $.each(poecc["benchcosts"][bckey][nsim_econfig[i]["method"][j][l]["tier"]],function(bkey,bnum){
                                                    ...
                                                    mcur.push({"name":"<img src='images/manual/method_chaos.png'/>"+applyLang("Basic")+"<div class='sep'>></div>"+sname,"id":bterm,"num":bnum});
                                                });
                                            }else{
                            ...
                            case 'essence' : 
                                if(j==1){
                                    ...
                                    switch(ename){
                                        case 'Horror' : case 'Hysteria' : case 'Insanity' : case 'Delirium' : 
                                            var nindex=8;
                                        break;
                                        default:
                                    ...
                                    mcur.push({"name":"<img src='images/manual/essence_Horror.png'/>"+applyLang("Essence")+"<div class='sep'>></div>"+name,"id":"essence_"+poecd["essences"]["seq"][poecd["essences"]["ind"][essid]]["name_essence"]+"_"+nindex,"num":1});
    ...
    if(!init){  
        ...
        if(nsim_benchrem>0){
            if(currencies["scour"]==undefined){
                currencies["scour"]={"label":"<img src='images/manual/method_chaos.png'/>"+applyLang("Basic")+"<div class='sep'>></div><img src='images/manual/method_scour.png'/>"+applyLang("Orb of Scouring"),"cnt":0};
            }
        ...
        if(successes>0){
            ...
            $.each(currencies,function(ckey,cur){
                if(nsim_ignorecur.indexOf("|"+ckey+"|")>-1){}else{
                    ...
                    if(ckey.indexOf("fossil_")>-1){
                        ...
                        switch(fosid){
                            case 'perfect':fosname="Perfect";break;
                            case 'gilded':fosname="Gilded";break;
                            case 'tangled':fosname="Tangled";break;
                            default:var fosname=poecd["fossils"]["seq"][poecd["fossils"]["ind"][fosid]]["name_fossil"];break;
                        }
            ...
            if(nsimStoreDist){
                ...
                $.each(nsim_distributions["mod"],function(key,num){
                    if(num>0){
                        ...
                        if(nmod[nmods]==undefined){nmod[nmods]=0;}
                        nmod[nmods]+=num;
                ...
                nmbk.sort(function(a,b){ return a[0] > b[0] ? 1 : -1; });
                var totr=0;
                ...
                mdak["prefix"].sort(function(a,b){ return a[0] > b[0] ? 1 : -1; });
                mdak["prefix"].reverse();
                mdak["suffix"].sort(function(a,b){ return a[0] > b[0] ? 1 : -1; });
                mdak["suffix"].reverse();
...
function poec_simSetCurrentDebug(init){ 
    ...
    if(init){
        ...
        switch(nsim_econfig[nsim_cstep]["actions"]["win"]){
            case 'next' : dbs["win"]=nsim_cstep+2; break;
            case 'end' : dbs["win"]="E"; break;
            case 'step' : dbs["win"]=nsim_econfig[nsim_cstep]["actions"]["win_route"]; break;
        }
        switch(nsim_econfig[nsim_cstep]["actions"]["fail"]){
            case 'restart' : dbs["fail"]="S"; break;
            case 'step' : dbs["fail"]=nsim_econfig[nsim_cstep]["actions"]["fail_route"]; break;
        }
    }
    $("#poecSimDebugLayout").find(".dbstep"+dbs["cur"]).addClass("current");
    if(dbs["win"]){$("#poecSimDebugLayout").find(".dbstep"+dbs["win"]).addClass("win");}
    if(dbs["fail"]){$("#poecSimDebugLayout").find(".dbstep"+dbs["fail"]).addClass("fail");}
    // Update item
    var nidata={
        "quality":simulator_settings["quality"],
        ...
        if(simulator_config[i]["method"][0]!=null){
            ...
            if(simulator_config[i]["autopass"]==false){
                switch(simulator_config[i]["actions"]["fail"]){
                    ...
                    case 'step' : 
                        var isback="";
                        if(simulator_config[i]["actions"]["fail_route"]<i+1){isback="back ";}
                ...
                case 'fossil' : 
                    ...
                    if(simulator_config[i]["method"][1]){
                        ...
                        for(var j=0;j<fossils.length;j++){
                            if(j>0){what+="+";}
                            switch(fossils[j]){
                                case 'perfect':var fname=applyLang("Perfect");break;
                                case 'gilded':var fname=applyLang("Gilded");break;
                                case 'tangled':
                                    ...
                                    fname+=")";
                                break;
                                default:var fname=poecd["fossils"]["seq"][poecd["fossils"]["ind"][fossils[j]]]["name_fossil"];break;
                            }
                            what+=fname;
                        }
                    }
                ...
                case 'essence' : 
                    ...
                    switch(essname){
                        ...
                        default:
                            ...
                            switch(trueetier){
                                case 1 : esspref=applyLang("Whispering")+" "; break;
                                case 2 : esspref=applyLang("Muttering")+" "; break;
                                case 3 : esspref=applyLang("Weeping")+" "; break;
                                case 4 : esspref=applyLang("Wailing")+" "; break;
                                case 5 : esspref=applyLang("Screaming")+" "; break;
                                case 6 : esspref=applyLang("Shrieking")+" "; break;
                                case 7 : esspref=applyLang("Deafening")+" "; break;
                            }
                        break;
                    }
            ...
            switch(simulator_config[i]["actions"]["win"]){
                ...
                case 'step' : 
                    var isback="";
                    if(simulator_config[i]["actions"]["win_route"]<i+1){isback="back ";}
    ...
    if(!conds["autopass"]){
        if(conds["method"][0]=="modunveil"){
            ...
            for(var z=0;z<conds["vfilter"].length;z++){
                if(z>0){conditions+=applyLang("or")+" ";}
            ...
            for(var z=0;z<conds["filters"].length;z++){
                if(conds["filters"][z]["type"]=="or"||conds["filters"][z]["type"]=="and"){
                        ...
                        for(y=0;y<conds["filters"][z]["conds"].length;y++){
                            ...
                            if(isNaN(modid)){
                                ...
                                switch(conds["filters"][z]["conds"][y]["id"]){
                                    case 'open_prefix' : thiscond+=rnginst+" "+applyLang("Open Prefix"); break;
                                    case 'open_suffix' : thiscond+=rnginst+" "+applyLang("Open Suffix"); break;
                                    case 'open_affix' : thiscond+=rnginst+" "+applyLang("Open Affix"); break;
                                    case 'count_prefix' : thiscond+=rnginst+" "+applyLang("Prefix"); break;
                                    case 'count_suffix' : thiscond+=rnginst+" "+applyLang("Suffix"); break;
                                    case 'count_affix' : thiscond+=rnginst+" "+applyLang("Affix"); break;
                                    case 'count_iprefix' : thiscond+=rnginst+" "+applyLang("Influenced Prefix"); break;
                                    case 'count_isuffix' : thiscond+=rnginst+" "+applyLang("Influenced Suffix"); break;
                                    case 'count_iaffix' : thiscond+=rnginst+" "+applyLang("Influenced Affix"); break;
                                    case 'count_attack' : thiscond+=rnginst+" "+applyLang("Attack Modifiers"); break;
                                    case 'count_nattack' : thiscond+=rnginst+" "+applyLang("Non-Attack Modifiers"); break;
                                    case 'count_caster' : thiscond+=rnginst+" "+applyLang("Caster Modifiers"); break;
                                    case 'count_ncaster' : thiscond+=rnginst+" "+applyLang("Non-Caster Modifiers"); break;
                                    case 'veiled_prefix' : thiscond+=rnginst+" "+applyLang("Veiled Prefix"); break;
                                    case 'veiled_suffix' : thiscond+=rnginst+" "+applyLang("Veiled Suffix"); break;
                                    case 'quality' : thiscond+=rnginst+" "+applyLang("Quality"); break;
                                    case 'eldritch_blue' : thiscond+=applyLang("Eater of Worlds influence"); break;
                                    case 'eldritch_red' : thiscond+=applyLang("Searing Exarch influence"); break;
                                    default: // Pseudo
                    ...
                    for(y=0;y<conds["filters"][z]["conds"].length;y++){
                        if(notfilter!=""){notfilter+=" "+applyLang("nor")+" ";}
                        var modid=parseInt(conds["filters"][z]["conds"][y]["id"]);
                        if(isNaN(modid)){
                            // Special conditions
                            switch(conds["filters"][z]["conds"][y]["id"]){
...
var nsim_addarches={"Aurabot":"aurabot","Aurastacker":"aurastack","Omniscience":"omniscience","Wander":"wander","Melee":"melee","Ranged":"ranged","Summoner":"summoner","Self-cast":"selfcast"};
function poec_simInitSaveTab(){
    ...
    if(nsim_tagsels==null){
        ...
        var chtml="";
        var arrall=[];
        $.each(poeexd["supports"],function(pname,key){pname=pname.replace(" Support","");arrall.push([key,pname]);});
        $.each(poeexd["keystones"],function(pname,key){arrall.push([key,pname]);});
        $.each(nsim_addarches,function(pname,key){arrall.push([key,pname]);});
        arrall.sort(function(a,b){ return a[1] > b[1] ? 1 : -1; });
    ...
    var vHTML="";
    var checked=" unchecked";if(nsim_savesettings){if(nsim_savesettings["public"]){checked=" ischecked";}}
    vHTML+='<div class="nsimtagholder"><div class="mcui-checkbox '+checked+'" id="poecSimSaveIsPublic">'+applyLang("Public")+'</div></div>';
    var checked=" unchecked";if(nsim_savesettings){if(nsim_savesettings["ssf"]){checked=" ischecked";}}
    vHTML+='<div class="nsimtagholder"><div class="mcui-checkbox '+checked+'" id="poecSimSaveIsSSF">'+applyLang("SSF-Friendly")+'</div></div>';
    var checked=" unchecked";if(nsim_savesettings){if(nsim_savesettings["full"]){checked=" ischecked";}}
    ...
    $("#poecSimSaveIsPublic").mcuiCheck().setChange(function(){poec_nsimUpdateSaveSettings();});
    $("#poecSimSaveIsSSF").mcuiCheck().setChange(function(){poec_nsimUpdateSaveSettings();});
    $("#poecSimSaveIsFull").mcuiCheck().setChange(function(){poec_nsimUpdateSaveSettings();});
    ...
    if(ctags){
        if(ctags.length>1){
            ...
            for(var i=0;i<ctags.length;i++){
                ...
                switch(tgt){
                    case 'ge' : htags+=poeexd["gems"]["seq"][poeexd["gems"]["ind"][tgi]]["name_gem"]; break;
                    case 'cl' : htags+=poeexd["classes"]["seq"][poeexd["classes"]["ind"][tgi]]["name_class"]; break;
                    case 'ar' : htags+=nsim_archindex[tgi]; break;
                    case 'fo' : htags+=poecd["mtypes"]["seq"][poecd["mtypes"]["ind"][tgi]]["name_mtype"]; break;
                }
                htags+="</div>";
            }
        }
...
function poec_nsimSaveCraft(){
    ...
    var acajax = new mc_ajax("../../cgi/web/custom/user_operation.php",vQS,{target:$("#nsimResponseLoader"),complete:function(result){
        var error=null;
        try{
...
function poec_nsimGetCraftInfoTab(recip,from){
    ...
    if(nsteps==1){stepterm=applyLang("Step");}
    var addtags="";
    if(recip["ssf_friendly"]==1){addtags+="<div class='atag'>"+applyLang("SSF")+"</div>";}
    if(recip["is_fullcraft"]==1){addtags+="<div class='atag'>"+applyLang("Full")+"</div>";}
    if(recip["is_public"]==1){addtags+="<div class='atag'>"+applyLang("Public")+"</div>";}
...
function poec_nsimLoadRecipee(vThis,from){
    ...
    setTimeout(function(){poec_nsimLoadRecipeeGO(vThis,from);},1);
}
...
function poec_nsimDeleteCraft(delta,init){
    if(init){
        $("#poec_nsimDeleteCraftBtn").mcuiNotice({text:applyLang("Are you sure you wish to delete this craft?"),type:"confirm",complete:function(delta){poec_nsimDeleteCraft(delta,false);}}).showNotice();
    }else{
        if(delta==true){
            $("#poec_nsimSaveCraftBtnZone").hide();
    ...
    if($("#poecRecipees").length==0){
        ...
        vHTML+="<div id='poecAffOptions' class='rec'>";
            ...
            for(var i=0;i<poeaf["iindex"].length;i++){
                tarrBitems.push({"id":poeaf["iindex"][i],"name":poecd["bitems"]["seq"][poecd["bitems"]["ind"][poeaf["iindex"][i]]]["name_bitem"]});
            ...
            for(var i=0;i<poecd["mtypes"]["seq"].length;i++){
                if(poecd["mtypes"]["seq"][i]["jewellery_tag"]==0){
                    tarrFocus.push({"id":poecd["mtypes"]["seq"][i]["id_mtype"],"name":poecd["mtypes"]["seq"][i]["name_mtype"]});
                }
            }
        ...
        $("#poecAffOptions.rec").find(".mcui-checkbox").mcuiCheck({"change":function(){poec_recSetOptions(false);}});
        $("#poecRecOutMode").mcuiRadio({"change":function(){poec_buildRecipeesOutput();}});
...
function poec_buildRecipeesOutput(){
    ...
    setTimeout(function(){poec_buildRecipeesOutputGO();},1);
}
    ...
    switch(omode){
        case 'l' :
            ...
            for(var i=0;i<rdata.length;i++){
                ...
                var addtags="";
                if(rdata[i]["ssf_friendly"]==1){addtags+="<div class='atag'>"+applyLang("SSF")+"</div>";}
                if(rdata[i]["is_fullcraft"]==1){addtags+="<div class='atag'>"+applyLang("Full")+"</div>";}
                if(rdata[i]["is_public"]==1){addtags+="<div class='atag'>"+applyLang("Public")+"</div>";}
                var crtags="";
                if(rdata[i]["cmets"]){
...
function poec_initRecSearchFilter(){
    ...
    $("#poecRecFilterInput").keyup(function(){poec_recSearchFilterGO();}).focus(function(){
        if($(this).hasClass("init")){
...
function poec_recUpdateResult(){
    ...
    poec_recrtm=setTimeout(function(){poec_recUpdateResultGO(0);},500);
}
...
function poec_recUpdateResultGO(vPG){
    ...
    var acajax = new mc_ajax("../../cgi/web/custom/get_recipees.php",vQS,{target:$("#poecRecipeesOutput"),complete:function(result){
...
function poec_simInitFlowchart(){
    ...
    setTimeout(function(){poec_simInitFlowchartGO();},1);
}
...
function poec_nsimParseFlowConfig(){
    if(simulator_flow==null){
        simulator_flow={"split":$("#poecSimFlowSplit").mcuiCheck().getVal(),"into":$("#poecSimFlowSplitConf").val(),"layout":{}};
    }
    for(var i=0;i<simulator_config.length;i++){
...
function poec_simInitFlowchartGO(){
    ...
    try{
        ...
        for(var zn=0;zn<arrcharts.length;zn++){
            ...
            var is_start=false;
            var is_end=false;
            if(zn==0){is_start=true;}
            if(zn==arrcharts.length-1){is_end=true;}
            var flowdata={
                "def":"",
                "routing":"",
                "styling":""
                        ...
                        if(simulator_config[i]["method"][1]){
                            ...
                            for(var j=0;j<fossils.length;j++){
                                ...
                                switch(fossils[j]){
                                    case 'perfect':var fname=applyLang("Perfect");break;
                                    case 'gilded':var fname=applyLang("Gilded");break;
                                    case 'tangled':var fname=applyLang("Tangled");
                                    break;
                                    default:var fname=poecd["fossils"]["seq"][poecd["fossils"]["ind"][fossils[j]]]["name_fossil"];break;
                                }
                                what+=fname;
            ...
            poecFlowInitSizes.push({"w":$('#poecFlowDiagram'+zn).children("svg").attr("width"),"h":$('#poecFlowDiagram'+zn).children("svg").attr("height")});
...
function poec_flowGetStepDet(evt,opts,symbol){
    ...
    if(!ignore){
        if($("#nsimFlowDetStep"+tstep).length>0){
            ...
            $("<div>").attr({"id":"nsimFlowDetStep"+tstep}).addClass("nsim_flowdet med_shadow "+opts["params"]["detc"]+addclass).css({"top":dtop,"left":dleft}).html(dHTML).appendTo($("body"));

            if($("#poecSimFlowEditing").mcuiCheck().getVal()){
                $("#nsimFlowDetStep"+tstep).find(".mcui-radio").mcuiRadio({change:function(val,elem){
...
function poec_getFlowRoutingChoices(val){
    ...
    for(var i=0;i<choices.length;i++){
        if(val==choices[i]["val"]){var sel=" selected";}else{var sel="";}
